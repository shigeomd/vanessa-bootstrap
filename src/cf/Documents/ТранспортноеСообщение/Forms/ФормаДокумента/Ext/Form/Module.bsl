...
Процедура ДекорацияПосмотретьВложенияНажатие(Элемент)
	...
	ДокументооборотСКООперацииСФайламиКлиент.ОткрытьФайл(ВложениеДляОткрытия.Значение, ВложениеДляОткрытия.Представление);
...
Процедура ПоказатьXMLИзФайлаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ДокументооборотСКООперацииСФайламиКлиент.УдалитьФайлыНаКлиенте(, ВременныйФайл);
