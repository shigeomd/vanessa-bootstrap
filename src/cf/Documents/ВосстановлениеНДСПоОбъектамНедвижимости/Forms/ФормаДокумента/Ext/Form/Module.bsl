...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьЗаголовкиИДоступностьСубконто(Счет = Неопределено, Форма)
...
Процедура ПодготовитьФормуНаСервере()
	...
	УстановитьЗаголовкиИДоступностьСубконто(Объект.СчетСписанияНДС, ЭтаФорма);
...
Процедура СчетСписанияНДСПриИзменении(Элемент)
	...
	ПоляОбъекта = Новый Структура("Субконто1, Субконто2, Субконто3, Организация, ПодразделениеПоУмолчанию",
		"СубконтоСписанияНДС1",
		"СубконтоСписанияНДС2",
		"СубконтоСписанияНДС3",
		Объект.Организация,
