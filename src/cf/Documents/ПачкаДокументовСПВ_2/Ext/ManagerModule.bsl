...
Функция СформироватьЗапросПоШапкеДляПечати(МассивСсылок)
	...
	|	ПачкаДокументовСПВ_2.НаименованиеОрганиазции КАК НаименованиеОрганиазции,
...
#Область ПроцедурыПолученияФлрмированиеФайла
...
Функция СформироватьПечатнуюФормуСПВ_2(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПачкаДокументовСПВ_2_Форма_СПВ_2";
...
#Область ПроцедурыИФункцииДляПроверкиФайлаДокументы
