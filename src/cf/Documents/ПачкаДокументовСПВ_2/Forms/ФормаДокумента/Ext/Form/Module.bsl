...
Процедура УстановитьЗаголовкиПолейСтрокиСтажа(СтрокаСтажа)
	...
	СтрокаСтажа.ОснованиеВыслугиЛетЗаголвок = НСтр("ru = 'Основание:'");
...
Функция РуководительПредставление(Руководитель, Должность)
	...
	Если ЗначениеЗаполнено(Руководитель) Тогда
		НаименованиеРуководителя = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Руководитель, "Наименование");
		РуководительПредставление = ФизическиеЛицаКлиентСервер.ФамилияИнициалыФизЛица(НаименованиеРуководителя);
	Иначе
...
&НаКлиенте
Процедура Подключаемый_ВыполнитьКомандуПечатиЗавершение(Результат, ДополнительныеПараметры) Экспорт 
