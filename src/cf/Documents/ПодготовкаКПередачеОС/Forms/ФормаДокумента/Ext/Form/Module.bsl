...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = ПредопределенноеЗначение("РежимЗаписиДокумента.Проведение") Тогда
		КлючеваяОперация = "ПроведениеПодготовкаКПередачеОС";
...
Процедура ПриОткрытии(Отказ)
	Если Объект.Дата >= Дата('20130101') Тогда
		ПодключитьОбработчикОжидания("ПоказатьПредупреждениеОбИзмененияхПодготовкаКПередачеОС2013", 0.5, Истина) 
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура ПоказатьПредупреждениеОбИзмененияхПодготовкаКПередачеОС2013()
	
	ОбщегоНазначенияБПКлиент.ПоказатьПредупреждениеОбИзменениях("ПодготовкаКПередачеОС2013", , НастройкиПредупреждений);
