...
Процедура УстановитьУсловноеОформление()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КоэффициентУскоренияБУ");
	...
	// СрокПолезногоИспользованияНУ, СпециальныйКоэффициентНУ, АмортизацияДо2009, ФактическийСрокИспользованияДо2009

	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "СрокПолезногоИспользованияНУ");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "СпециальныйКоэффициентНУ");
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ПорядокПогашенияСтоимостиБУ = ПредопределенноеЗначение("Перечисление.ПорядокПогашенияСтоимостиОС.НачислениеАмортизации") Тогда
		Форма.Элементы.ГруппаСтраницыПогашениеСтоимостиБУ.ТекущаяСтраница = Форма.Элементы.ГруппаНачислениеАмортизацииБУ;
	ИначеЕсли Форма.ПорядокПогашенияСтоимостиБУ = ПредопределенноеЗначение("Перечисление.ПорядокПогашенияСтоимостиОС.НачислениеИзносаПоЕНАОФ") Тогда
		Форма.Элементы.ГруппаСтраницыПогашениеСтоимостиБУ.ТекущаяСтраница = Форма.Элементы.ГруппаНачислениеИзносаБУ;
	ИначеЕсли Форма.ПорядокПогашенияСтоимостиБУ = ПредопределенноеЗначение("Перечисление.ПорядокПогашенияСтоимостиОС.СтоимостьНеПогашается") Тогда
		Форма.Элементы.ГруппаСтраницыПогашениеСтоимостиБУ.ТекущаяСтраница = Форма.Элементы.ГруппаСтоимостьНеПогашаетсяБУ;
	Иначе
		Форма.Элементы.ГруппаСтраницыПогашениеСтоимостиБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПогашениеСтоимостиПустаяСтраницаБУ;
	КонецЕсли;
	
	Если Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.Линейный") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаЛинейныйСпособ;
	ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.УменьшаемогоОстатка") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаСпособУменьшаемогоОстатка;
	ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.ПоСуммеЧиселЛетИспользования") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПоСуммеЧиселЛетИспользования;
	ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.ПропорциональноОбъемуПродукции") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПропорциональноОбъемуПродукции;
	ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.ПоЕНАОФ") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПоЕНАОФ;
	ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииОС.ПоЕНАОФНа1000кмПробега") Тогда
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПоЕНАОФНа1000кмПробега;
	Иначе
		Форма.Элементы.ГруппаСтраницыСпособыНачисленияАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаСпособыНачисленияАмортизацииПустаяСтраница;
	КонецЕсли;
	...
	Если Форма.ПорядокВключенияСтоимостиВСоставРасходовНУ = ПредопределенноеЗначение("Перечисление.ПорядокВключенияСтоимостиОСВСоставРасходовНУ.НачислениеАмортизации") Тогда
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовНУ.ТекущаяСтраница = Форма.Элементы.ГруппаНачислениеАмортизацииНУСтраница;
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовИП.ТекущаяСтраница = Форма.Элементы.ГруппаНачислениеАмортизацииИП;
	ИначеЕсли Форма.ПорядокВключенияСтоимостиВСоставРасходовНУ = ПредопределенноеЗначение("Перечисление.ПорядокВключенияСтоимостиОСВСоставРасходовНУ.ВключениеВРасходыПриПринятииКУчету") Тогда
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовНУ.ТекущаяСтраница = Форма.Элементы.ГруппаСтоимостьНеВключаетсяВРасходы;
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовИП.ТекущаяСтраница = Форма.Элементы.ГруппаВключениеВРасходыПриПринятииКУчетуИП;
	Иначе
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовНУ.ТекущаяСтраница = Форма.Элементы.ГруппаПустаяСтраницаНУ;
		Форма.Элементы.ГруппаПорядокВключенияСтоимостиВСоставРасходовИП.ТекущаяСтраница = Форма.Элементы.ГруппаСтоимостьНеВключаетсяВРасходыИП;
	КонецЕсли;
	
	Если Форма.МетодНачисленияАмортизацииНУ = ПредопределенноеЗначение("Перечисление.МетодыНачисленияАмортизации.ПоЕНАОФ") Тогда
		Форма.Элементы.ГруппаМетодНачисленияАмортизацииИП.ТекущаяСтраница = Форма.Элементы.ГруппаЕНАОФ;
	ИначеЕсли Форма.МетодНачисленияАмортизацииНУ = ПредопределенноеЗначение("Перечисление.МетодыНачисленияАмортизации.Линейный") Тогда
		Форма.Элементы.ГруппаМетодНачисленияАмортизацииИП.ТекущаяСтраница = Форма.Элементы.ГруппаЛинейный;
	Иначе
		Форма.Элементы.ГруппаМетодНачисленияАмортизацииИП.ТекущаяСтраница = Форма.Элементы.ГруппаПустая;
	КонецЕсли;
	...
	Форма.Элементы.ГрафикАмортизацииБУЛинейный.Доступность = Форма.СезонныйХарактерПроизводства;
	Форма.Элементы.СезонныйХарактерПроизводстваУменьшаемогоОстатка.Доступность = Форма.СезонныйХарактерПроизводства;
	Форма.Элементы.СезонныйХарактерПроизводстваПоСуммеЧиселЛетИспользования.Доступность = Форма.СезонныйХарактерПроизводства;
	Форма.Элементы.СезонныйХарактерПроизводстваПоЕНАОФ.Доступность = Форма.СезонныйХарактерПроизводства;
...
Процедура ОчиститьНеиспользуемыеРеквизиты()
	...
	Если НЕ СезонныйХарактерПроизводства Тогда
...
&НаКлиенте
Процедура СезонныйХарактерПроизводстваПриИзменении(Элемент)
	
	Если СезонныйХарактерПроизводства = Ложь Тогда
	
		Если НЕ ГрафикАмортизацииБУ.Пустая() Тогда
			
			ТекстВопроса =
				НСтр("ru='Поле ""График амортизации по году"" будет очищено.
				|Продолжить?'");
			
			Оповещение = Новый ОписаниеОповещения("ВопросОчищениеГрафикаАмортизацииЗавершение", ЭтотОбъект);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоНовый И НЕ Параметры.Копирование Тогда
		...
		НачислятьАмортизациюНУ = Истина;
		СезонныйХарактерПроизводства = Ложь;
		СпециальныйКоэффициентНУ = 1;
