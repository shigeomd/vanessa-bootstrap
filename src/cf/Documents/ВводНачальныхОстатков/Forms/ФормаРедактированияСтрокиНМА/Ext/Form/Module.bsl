...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ВидОбъектаУчета = ПредопределенноеЗначение("Перечисление.ВидыОбъектовУчетаНМА.НематериальныйАктив") Тогда
		...
		Форма.Элементы.ГруппаСпособПоступлениеНМА_НИОКР.ТекущаяСтраница = Форма.Элементы.ГруппаСпособПоступленияНМА;
		...
		Форма.Элементы.ГруппаПараметрыАмортизацииНУСтраницы.ТекущаяСтраница = Форма.Элементы.ГруппаПараметрыАмортизацииНУНМА;
		Если Форма.НачислятьАмортизациюНУ Тогда
			Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииНУ_НМА.ТекущаяСтраница = Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииНУНМАНачислять;
			Форма.Элементы.ГруппаНачислениеАмортизацииИП.ТекущаяСтраница = Форма.Элементы.ГруппаСписыватьРасходыИП;
		Иначе
			Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииНУ_НМА.ТекущаяСтраница = Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииНУНМАНеНачислять;
			Форма.Элементы.ГруппаНачислениеАмортизацииИП.ТекущаяСтраница = Форма.Элементы.ГруппаПустаяИП;
		КонецЕсли;
	Иначе
		...
		Форма.Элементы.ГруппаСпособПоступлениеНМА_НИОКР.ТекущаяСтраница = Форма.Элементы.ГруппаСпособПоступленияНИОКР;
		СписокСпособовНачисленияАмортизацииБУ.Добавить(
			ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииНМА.Линейный"));
		СписокСпособовНачисленияАмортизацииБУ.Добавить(
			ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииНМА.ПропорциональноОбъемуПродукции"));
		...
		Форма.Элементы.ГруппаПараметрыАмортизацииНУСтраницы.ТекущаяСтраница = Форма.Элементы.ГруппаПараметрыСписанияРасходовНУ_НИОКР;
	...
	Если Форма.НачислятьАмортизациюБУ Тогда
		Форма.Элементы.ГруппаПараметрыАмортизацииБУСтраницы.ТекущаяСтраница =
			Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииБУСтраницаНачислять;
			
		Если Форма.СпособНачисленияАмортизацииБУ = 
				ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииНМА.УменьшаемогоОстатка") Тогда
			Форма.Элементы.ГруппаКоэффициентыАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаУменьшаемогоОстатка;
		ИначеЕсли Форма.СпособНачисленияАмортизацииБУ = 
				ПредопределенноеЗначение("Перечисление.СпособыНачисленияАмортизацииНМА.ПропорциональноОбъемуПродукции") Тогда
			Форма.Элементы.ГруппаКоэффициентыАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаПропорциональноПродукции;
		Иначе
			Форма.Элементы.ГруппаКоэффициентыАмортизацииБУ.ТекущаяСтраница = Форма.Элементы.ГруппаЛинейный;
		КонецЕсли;
	Иначе
		Форма.Элементы.ГруппаПараметрыАмортизацииБУСтраницы.ТекущаяСтраница =
			Форма.Элементы.ГруппаПараметрыНачисленияАмортизацииБУСтраницаНеНачислять;
	КонецЕсли;
