...
Процедура ПодготовитьФормуНаСервере()
	...
	Если ВидыДоговоров.Количество() > 0 Тогда
		...
		ПараметрыВыбора.Добавить(Новый ПараметрВыбора("Отбор.ВидДоговора", Новый ФиксированныйМассив(ВидыДоговоров)));
		Элементы.РасчетыСКонтрагентамиДоговорКонтрагента.ПараметрыВыбора = Новый ФиксированныйМассив(ПараметрыВыбора);
