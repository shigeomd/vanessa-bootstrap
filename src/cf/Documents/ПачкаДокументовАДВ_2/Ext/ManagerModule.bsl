...
Функция ПолучитьСоответствиеПроверяемыхРеквизитовОткрываемымОбъектам(ДокументСсылка, ДанныеДляПроверки) Экспорт
	...
	СтруктураСоответствия.Вставить("ФамлияВСвидетельстве", ДокументСсылка);
...
Функция СформироватьЗапросПоСотрудникамДляПечати(МассивОбъектов)
	...
	|	ПачкаДокументовАДВ_2Сотрудники.ДатаПолученияСвидетельства,
	|	ПачкаДокументовАДВ_2Сотрудники.СтраховойНомерПФРВСвидетельстве,
	|	ПачкаДокументовАДВ_2Сотрудники.ФамилияВСвидетельстве,
	|	ПачкаДокументовАДВ_2Сотрудники.ИмяВСвидетельстве,
	|	ПачкаДокументовАДВ_2Сотрудники.ОтчествоВСвидетельстве,
	|	ПачкаДокументовАДВ_2Сотрудники.Фамилия,
	|	ПачкаДокументовАДВ_2Сотрудники.Имя,
	|	ПачкаДокументовАДВ_2Сотрудники.Отчество,
	|	ПачкаДокументовАДВ_2Сотрудники.Пол,
	|	ПачкаДокументовАДВ_2Сотрудники.ДатаРождения,
	|	ПачкаДокументовАДВ_2Сотрудники.МестоРождения,
	|	ПачкаДокументовАДВ_2Сотрудники.МестоРожденияПредставление,
	|	ПачкаДокументовАДВ_2Сотрудники.Гражданство,
	|	ПачкаДокументовАДВ_2Сотрудники.АдресРегистрации,
	|	ПачкаДокументовАДВ_2Сотрудники.АдресФактический,
	|	ПачкаДокументовАДВ_2Сотрудники.АдресРегистрацииПредставление,
	|	ПачкаДокументовАДВ_2Сотрудники.АдресФактическийПредставление,
	|	ПачкаДокументовАДВ_2Сотрудники.Телефоны,
	|	ПачкаДокументовАДВ_2Сотрудники.ПризнакОтменыОтчества,
	|	ПачкаДокументовАДВ_2Сотрудники.ПризнакОтменыМестаРождения,
	|	ПачкаДокументовАДВ_2Сотрудники.ВидДокумента,
	|	ПачкаДокументовАДВ_2Сотрудники.СерияДокумента,
	|	ПачкаДокументовАДВ_2Сотрудники.НомерДокумента,
	|	ПачкаДокументовАДВ_2Сотрудники.ДатаВыдачи,
	|	ПачкаДокументовАДВ_2Сотрудники.КемВыдан,
	|	ПачкаДокументовАДВ_2Сотрудники.ВидДокумента.КодПФР КАК ВидДокументаКодПФР,
	|	ПачкаДокументовАДВ_2Сотрудники.Ссылка.Дата
	|ИЗ
...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаСотрудники)
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаСотрудники.МестоРождения) Тогда
			...
			НаборЗаписейМестоРождения.ГородРождения = ПерсонифицированныйУчет.ПолучитьИмяИАдресноеСокращение(МестоРождения.НаселенныйПункт,Сокращение);
			НаборЗаписейМестоРождения.РайонРождения = ПерсонифицированныйУчет.ПолучитьИмяИАдресноеСокращение(МестоРождения.Район, Сокращение);
		...
		ДанныеДокумента = ПерсонифицированныйУчет.ПолучитьДанныеДокументаВФорматеПФР(ВыборкаСотрудники.ВидДокумента, ВыборкаСотрудники.СерияДокумента, 
				...
				ВыборкаСотрудники.КемВыдан, ВыборкаСотрудники.ВидДокументаКодПФР);
...
Функция СформироватьЗапросПоСотрудникам(Ссылка)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ПачкаДокументовАДВ_2Сотрудники.Ссылка,
	|	ПачкаДокументовАДВ_2Сотрудники.НомерСтроки,
	|	ПачкаДокументовАДВ_2Сотрудники.Сотрудник КАК ФизическоеЛицо,
	|	ПачкаДокументовАДВ_2Сотрудники.ДатаПолученияСвидетельства,
	|	ПачкаДокументовАДВ_2Сотрудники.СтраховойНомерПФРВСвидетельстве,
	|	ПачкаДокументовАДВ_2Сотрудники.ФамилияВСвидетельстве,
...
Функция СформироватьПечатнуюФормуАДВ2(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_АнкетаЗастрахованногоЛица_ФормаАДВ_2";
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Пока ВыборкаСотрудники.Следующий() Цикл
			...
			МестоРождения.НаселенныйПункт = ПерсонифицированныйУчет.ПолучитьИмяИАдресноеСокращение(МестоРождения.НаселенныйПункт,Сокращение);
			ОбластьЗаявление.Параметры.МестоРожденияГород =  ПерсонифицированныйУчет.СтрокаВОтчет(МестоРождения.НаселенныйПункт);
			МестоРождения.Район = ПерсонифицированныйУчет.ПолучитьИмяИАдресноеСокращение(МестоРождения.Район, Сокращение);
			...
			СтруктураАдресРегистрации = УправлениеКонтактнойИнформацией.ПредыдущаяСтруктураКонтактнойИнформацииXML(
					ВыборкаСотрудники.АдресРегистрации, Справочники.ВидыКонтактнойИнформации.АдресПоПропискеФизическиеЛица);
			СтруктураАдресФактический = УправлениеКонтактнойИнформацией.ПредыдущаяСтруктураКонтактнойИнформацииXML(
					ВыборкаСотрудники.АдресФактический, Справочники.ВидыКонтактнойИнформации.АдресМестаПроживанияФизическиеЛица);
			
			АдресРегистрации = ПерсонифицированныйУчет.ПолучитьПредставлениеАдресаДляПФР(СтруктураАдресРегистрации);
			АдресФактический = ПерсонифицированныйУчет.ПолучитьПредставлениеАдресаДляПФР(СтруктураАдресФактический);
			
			ОбластьЗаявление.Параметры.АдресРегистрации = ПерсонифицированныйУчет.СтрокаВОтчет(АдресРегистрации);
			ОбластьЗаявление.Параметры.АдресФактический = ПерсонифицированныйУчет.СтрокаВОтчет(АдресФактический);
			...
			ДанныеДокумента = ПерсонифицированныйУчет.ПолучитьДанныеДокументаВФорматеПФР(ВыборкаСотрудники.ВидДокумента, ВыборкаСотрудники.СерияДокумента, ВыборкаСотрудники.НомерДокумента,
					ВыборкаСотрудники.ДатаВыдачи, ВыборкаСотрудники.КемВыдан, ВыборкаСотрудники.ВидДокументаКодПФР);
...
Функция СформироватьПечатнуюФормуАДВ6(МассивОбъектов, ОбъектыПечати)
	Возврат ПерсонифицированныйУчет.ВывестиОписьАДВ6(МассивОбъектов, ОбъектыПечати, "ОБМН");
КонецФункции
