...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	|	Реквизиты.СчетУчетаРасчетовПоПретензиям,
...
Функция ТекстЗапросаВременныеТаблицыДокумента(НомераТаблиц, Реквизиты)
	...
	Если Реквизиты.ЕстьТовары Тогда
		...
		|	ВЫБОР
		|		КОГДА &РасчетыВВалюте И ВозвратТоваровПоставщику.КурсВзаиморасчетов <> 0
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "Накладная") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "Накладная", "Возврат поставщику",
			ПечатьВозвратаПоставщику(МассивОбъектов, ОбъектыПечати), , "Документ.ВозвратТоваровПоставщику.ПФ_MXL_Накладная");
	КонецЕсли;
...
//
Функция ПечатьВозвратаПоставщику(МассивОбъектов, ОбъектыПечати)
...
Функция ПолучитьТекстЗапросаДляФормированияПечатнойФормыТОРГ12(НомераТаблиц)
	...
	|	СУММА(ВозвратТоваровПоставщику.СуммаНДС) КАК СуммаНДС,
	...
	|	ВозвратТоваровПоставщику.СтранаПроисхождения,
	|	ВозвратТоваровПоставщику.СтавкаНДС,
	|	ЕСТЬNULL(ВозвратТоваровПоставщику.СчетУчета.Забалансовый, ЛОЖЬ),
