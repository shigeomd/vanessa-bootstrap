...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("ПлатежныеРеквизиты")
		И НЕ Параметры.Свойство("Контрагент") Тогда
		Отказ = Истина;
		Возврат;
	КонецЕсли;
	
	Реквизиты = ДанныеГосударственныхОрганов.ПолучитьПлатежныеРеквизитыКонтрагента(Параметры.Контрагент);
