...
Процедура ПриОткрытии(Отказ)
	...
	Если ОткрытьФормуОтчета Тогда
		...
		Если Объект.ИсточникОтчета = "РегламентированныйОтчетСтатистикаПрочиеФормы" Тогда
			ВыбраннаяФорма = ?(Найти(Объект.ВыбраннаяФорма, "_") = 0,
				Объект.ВыбраннаяФорма, Лев(Объект.ВыбраннаяФорма, Найти(Объект.ВыбраннаяФорма, "_") - 1));
		Иначе
		...
		Если мСкопированаФорма <> Неопределено Тогда
			Если (Владелецформы.ИмяФормы = "ОбщаяФорма.РегламентированнаяОтчетность") 
				ИЛИ (Владелецформы.ИмяФормы = "Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.УправлениеОтчетностью")
