...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КлючНастроек = "БыстроеОсвоениеСчетНаОплатуПоставщика, ПрисоединенныеФайлы";
...
Процедура ПоказатьБыстроеОсвоение()
	...
	ОбщегоНазначенияБПКлиент.ПоказатьПредупреждениеОбИзменениях("БыстроеОсвоениеСчетНаОплатуПоставщика", , НастройкиПредупреждений);
