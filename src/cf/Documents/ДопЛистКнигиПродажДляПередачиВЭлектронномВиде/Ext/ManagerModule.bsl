...
Процедура ЗаполнитьТабличнуюЧасть(СтруктураПараметров, ДанныеДляЗаполнения)
	...
	ТабличнаяЧасть = Документы.ДопЛистКнигиПродажДляПередачиВЭлектронномВиде.ПустаяСсылка().ТабличнаяЧасть.ВыгрузитьКолонки();
	...
	ИтогЗаПериод = Документы.ДопЛистКнигиПродажДляПередачиВЭлектронномВиде.ПолучитьИтогиЗаПериодКнигаПродаж(СтруктураПараметров);
...
Функция ПечатьДополнительногоЛистаКнигиПродаж(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ДополнительныйЛистКнигиПродаж";
