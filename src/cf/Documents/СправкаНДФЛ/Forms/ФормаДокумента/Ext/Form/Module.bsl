...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	ЗаполнитьДанныеСправкиПоТаблицеДоходыНалоги(ТекущийОбъект);
КонецПроцедуры
...
Процедура СотрудникиДатаУведомленияПриИзменении(Элемент)
	...
	ЗарплатаКадрыОтображениеОшибокКлиент.ПриИзмененииДанныхВЭлементеСФлагомИндикацииОшибок(ЭтотОбъект, Элемент, "Объект.ДатаУведомления");
КонецПроцедуры

&НаКлиенте
Процедура СотрудникиНомерУведомленияПриИзменении(Элемент)
	УчетНДФЛКлиент.СправкиНДФЛПриОкончанииРедактирования(ЭтаФорма, Объект, Объект, СтарыеЗначенияКонтролируемыхПолей, КонтролируемыеПоля, "Уведомление");
	ЗарплатаКадрыОтображениеОшибокКлиент.ПриИзмененииДанныхВЭлементеСФлагомИндикацииОшибок(ЭтотОбъект, Элемент, "Объект.НомерУведомления");
КонецПроцедуры

&НаКлиенте
Процедура СотрудникиКодНалоговогоОрганаУведомленияПриИзменении(Элемент)
	УчетНДФЛКлиент.СправкиНДФЛПриОкончанииРедактирования(ЭтаФорма, Объект, Объект, СтарыеЗначенияКонтролируемыхПолей, КонтролируемыеПоля, "Уведомление");
	ЗарплатаКадрыОтображениеОшибокКлиент.ПриИзмененииДанныхВЭлементеСФлагомИндикацииОшибок(ЭтотОбъект, Элемент, "Объект.КодНалоговогоОрганаУведомления");
КонецПроцедуры
...
Процедура СведенияОДоходахМесяцНалоговогоПериодаПриИзменении(Элемент)
	Элементы.СведенияОДоходах.ТекущиеДанные.МесяцНалоговогоПериода = МесяцНалоговогоПериодаПоСтроковомуПредставлению(Элементы.СведенияОДоходах.ТекущиеДанные.МесяцНалоговогоПериодаСтрокой); 
КонецПроцедуры
...
Процедура УстановитьИнофнадписьОписаниеДоходовОрганизации()
	...
	УчетНДФЛФормы.СправкаНДФЛУстановитьИнофнадписьОписаниеДоходовОрганизации(ЭтаФорма, ЭтоСводнаяСправка, Объект.Сотрудник);
КонецПроцедуры
...
Функция ПоместитьДанныеСправкиВХранилище()
	ЗаполнитьДанныеСправкиПоТаблицеДоходыНалоги(Объект);
