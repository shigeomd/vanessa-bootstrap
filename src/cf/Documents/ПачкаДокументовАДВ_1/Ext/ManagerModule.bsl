...
//
// Параметры: 
//  МасссивСсылок - в качестве параметра можент передавться либо масси ссылок на документы "ПачкаДокументовАДВ_1",
...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаСотрудники)
	...
	Пока ВыборкаСотрудники.Следующий()	Цикл
		...
		ДанныеДокумента = ПерсонифицированныйУчет.ПолучитьДанныеДокументаВФорматеПФР(ВыборкаСотрудники.ДокументВид, ВыборкаСотрудники.ДокументСерия, 
				...
				ВыборкаСотрудники.ДокументКемВыдан, ВыборкаСотрудники.ДокументВидКодПФР);
...
Функция СформироватьПечатнуюФормуАДВ1(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_АнкетаЗастрахованногоЛица_ФормаАДВ_1";
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Пока ВыборкаСотрудники.Следующий() Цикл
			...
			ОбластьАнкета.Параметры.АдресРегистрации = ПерсонифицированныйУчет.СтрокаВОтчет(АдресРегистрации);
			ОбластьАнкета.Параметры.АдресФактический = ПерсонифицированныйУчет.СтрокаВОтчет(АдресФактический);
...
Функция СформироватьПечатнуюФормуАДВ6(МассивОбъектов, ОбъектыПечати)
	Возврат ПерсонифицированныйУчет.ВывестиОписьАДВ6(МассивОбъектов, ОбъектыПечати, "АНКТ");
КонецФункции
