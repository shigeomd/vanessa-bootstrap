...
Процедура ОбработкаПроведения(Отказ)
	...
	УчетОС.СформироватьДвиженияИзменениеСпособовОтраженияРасходовПоАмортизацииОСБУ(ПараметрыПроведения.СпособОтраженияРасходовПоАмортизацииОСТаблица,
		ПараметрыПроведения.СпособОтраженияРасходовПоАмортизацииОС, Движения, Отказ);
