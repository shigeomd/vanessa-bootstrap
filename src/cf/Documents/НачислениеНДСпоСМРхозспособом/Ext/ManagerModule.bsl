...
Функция ЗаполнитьСМРхозспособом(ПараметрыДокумента)
	...
	Запрос.УстановитьПараметр("СчетаУчетаСтроительства", 		 
	...
	Запрос.УстановитьПараметр("СтавкаНДСЗначение", 				 УчетНДСВызовСервераПовтИсп.ПолучитьСтавкуНДС(Перечисления.СтавкиНДС.НДС18));
