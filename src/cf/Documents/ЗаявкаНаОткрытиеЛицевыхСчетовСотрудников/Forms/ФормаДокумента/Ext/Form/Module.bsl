...
Процедура Подключаемый_ОткрытьДокументПодтверждение(Команда)
	...
	ОткрытьФорму("Документ.ПодтверждениеОткрытияЛицевыхСчетовСотрудников.ФормаОбъекта", ПараметрыФормы, , ЭтаФорма.ДокументПодтверждениеИзБанка);
...
Процедура УстановитьЦветЭмбоссированногоТекста(Элементы, ТекущиеДанные, ЦветСтиляПоясняющийОшибкуТекст, ЦветТекстаФормы, ИмяРедактируемогоЭлемента = Неопределено, ТекстРедактирования = Неопределено)
	...
	Если ИмяРедактируемогоЭлемента <> Неопределено И Найти(ИмяРедактируемогоЭлемента, "ЭмбоссированныйТекст1") > 0 Тогда
	...
	КонецЕсли;
	Если ИмяРедактируемогоЭлемента <> Неопределено И Найти(ИмяРедактируемогоЭлемента, "ЭмбоссированныйТекст2") > 0 Тогда
	...
	КонецЕсли;
	Если ИмяРедактируемогоЭлемента <> Неопределено И Найти(ИмяРедактируемогоЭлемента, "ЭмбоссированныйТекст3") > 0 Тогда
		ДлинаЭмбоссированногоТекста = ДлинаЭмбоссированногоТекста + СтрДлина(ТекстРедактирования);
	Иначе
