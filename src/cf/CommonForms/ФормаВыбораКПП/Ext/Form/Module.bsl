...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РольКонтрагента = "Поставщик" Тогда
		...
		ТекстПодсказки = НСтр("ru = 'При приобретении товаров и услуг через обособленные подразделения контрагентов, 
	...
	ИначеЕсли Параметры.РольКонтрагента = "Покупатель" Тогда
		...
		ТекстПодсказки = НСтр("ru = 'При реализации товаров и услуг обособленным подразделениям контрагентов, 
