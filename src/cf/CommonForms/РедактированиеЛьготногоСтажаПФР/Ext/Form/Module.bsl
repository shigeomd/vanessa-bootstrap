...
&НаКлиенте
Процедура Подключаемый_ПоказатьОшибки(Элемент, СтандартнаяОбработка)
	ПерсонифицированныйУчетКлиент.ПоказатьОшибки(ЭтаФорма, Элемент, СтандартнаяОбработка);	
КонецПроцедуры	
...
Процедура ЗаполнитьДанныеОСтаже()
	...
	Если Параметры.ОтображатьОшибки Тогда
		ПерсонифицированныйУчетФормы.ФормаДетальныхДанныхЗаполнитьЗначенияРеквизитовХраненияОшибок(
			ЭтаФорма, 
			ЭтаФорма,
			Параметры.ДанныеСтажа.ЗначенияРеквизитовХраненияОшибок, 
			""); 
	КонецЕсли;
...
Функция ОписаниеЭлементовСИндикациейОшибок() Экспорт
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "Сотрудник";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	ОписаниеЭлемента.ИмяЭлементаФормы = "НомерОсновнойЗаписи";
	...
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	ОписаниеЭлемента.ИмяЭлементаФормы = "НомерДополнительнойЗаписи";
	...
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	ОписаниеЭлемента.ИмяЭлементаФормы = "ДатаНачалаПериода";

	ОписаниеЭлемента = ПерсонифицированныйУчетФормы.ДобавитьОписаниеЭлементаИндикацииОшибок(
							ОписаниеЭлементовИндикацииОшибок, 
							"ДатаОкончанияПериода");

	ОписаниеЭлемента.ИмяЭлементаФормы = "ДатаОкончанияПериода";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ОсобыеУсловияТруда";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "КодПозицииСписка";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";

	ОписаниеЭлемента = ПерсонифицированныйУчетФормы.ДобавитьОписаниеЭлементаИндикацииОшибок(
							ОписаниеЭлементовИндикацииОшибок, 
							"ОснованиеИсчисляемогоСтажа");

	ОписаниеЭлемента.ИмяЭлементаФормы = "ОснованиеИсчисляемогоСтажа";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ПервыйПараметрИсчисляемогоСтажа";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ВторойПараметрИсчисляемогоСтажа";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ТретийПараметрИсчисляемогоСтажа";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ОснованиеВыслугиЛет";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ПервыйПараметрВыслугиЛет";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ВторойПараметрВыслугиЛет";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ТретийПараметрВыслугиЛет";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	...
	ОписаниеЭлемента.ИмяЭлементаФормы = "ТерриториальныеУсловия";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
	
	ОписаниеЭлемента = ПерсонифицированныйУчетФормы.ДобавитьОписаниеЭлементаИндикацииОшибок(
						ОписаниеЭлементовИндикацииОшибок, 
						"ПараметрТерриториальныхУсловий");

	ОписаниеЭлемента.ИмяЭлементаФормы = "ПараметрТерриториальныхУсловий";
	ОписаниеЭлемента.ПутьКХранилищуОшибок = "";	
