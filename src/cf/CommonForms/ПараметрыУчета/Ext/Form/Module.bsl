...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ПараметрыУчета = ПолучитьСтруктуруПараметровУчета(ЭтаФорма);
	ОбщегоНазначенияБПВызовСервера.ПрименитьПараметрыУчета(ПараметрыУчета, ИзмененыПараметрыСубконто, Отказ, Ложь, НаборКонстант.ВестиУчетЗатратПоПодразделениям);
