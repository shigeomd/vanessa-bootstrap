...
Процедура Проверить(Команда)
	...
	ДокументооборотСКОКриптографияКлиент.ПроверитьСертификат(Оповещение, Сертификат);
...
Процедура ОткрытьСертификат(Команда)
	...
	Иначе
		...
		ДокументооборотСКОКриптографияКлиент.ЭкспортироватьСертификатВФайл(
...
Процедура ОткрытьСертификатПослеЭкспортаСертификата(Результат, ВходящийКонтекст) Экспорт
	...
	Если Результат.Выполнено Тогда
		ДокументооборотСКООперацииСФайламиКлиент.ОткрытьФайл(Результат.ИмяФайлаСертификата);
	Иначе
...
Функция РазобратьСтрокуСубъекта(СтрокаДляРазбора)
	...
	ИндексРавно = СтроковыеФункцииКлиентСервер.НайтиСимволСКонца(ПодстрокаДляРазбора, "=");
	Пока ИндексРавно Цикл
		...
		ИндексЗапятая = СтроковыеФункцииКлиентСервер.НайтиСимволСКонца(ПодстрокаДляРазбора, ",");
