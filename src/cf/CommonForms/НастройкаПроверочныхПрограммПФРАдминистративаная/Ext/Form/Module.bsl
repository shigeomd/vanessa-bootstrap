...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьИнфонадписьНастройкаПроверочныхПрограмм();
...
Процедура НастройкиПроверочныхПрограммКаталогПрограммыCheckUFAПриИзменении(Элемент)	
	...
	НастройкиПроверочныхПрограмм.ВыполнятьПроверкуНаСервере = НастройкиПроверочныхПрограмм.ПроверятьПрограммойCheckUFA
																Или НастройкиПроверочныхПрограмм.ПроверятьПрограммойCheckXML;
...
Процедура УстановитьПодсказкуКЭлементуКаталогПрограммыCheckXML()	
	...
	Иначе
		...
		Элементы.НастройкиПроверочныхПрограммКаталогПрограммыCheckXML.Подсказка = "";
	КонецЕсли;		
КонецПроцедуры	
...
Процедура УстановитьПодсказкуКЭлементуКаталогПрограммыCheckUFA()
	...
	Иначе
		...
		Элементы.НастройкиПроверочныхПрограммКаталогПрограммыCheckUFA.Подсказка = "";
	КонецЕсли;		
КонецПроцедуры
...
&НаСервере
Процедура УстановитьИнфонадписьНастройкаПроверочныхПрограмм()
	Если ЭтоФайловаяИБ Тогда
		НастройкаПроверочныхПрограммИфонадпись = НСтр("ru = 'Возможность настройки проверочных программ предусмотрена только для клиент-серверных информационных баз.'");		
		ВыполнятьПроверкуНаСервереКартинкаИнфо = БиблиотекаКартинок.Предупреждение;	
	Иначе 	
		НастройкаПроверочныхПрограммИфонадпись = НСтр("ru = 'Установите флажок, если проверки программами ПФР будут выполняться на сервере. Для работы проверочных программ необходимо, чтобы все сервера кластера использовали операционную систему Windows. Так же для пользователя операционной системы, под которым запущен сервер 1С: Предприятие должна быть возможность запускать проверочные программы ПФР.'");	
		ВыполнятьПроверкуНаСервереКартинкаИнфо = БиблиотекаКартинок.Информация;		
	КонецЕсли;	
КонецПроцедуры	
