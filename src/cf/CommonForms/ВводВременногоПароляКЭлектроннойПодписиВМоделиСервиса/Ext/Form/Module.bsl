...
Процедура Подтвердить(Команда)
	...
	Если ЗначениеЗаполнено(ВведенныйПароль) И СтрДлина(ВведенныйПароль) = 6 Тогда
		...
		Исключение
			...
			Если Найти(ПодробноеПредставлениеОшибки(ИнформацияОбОшибке), КриптосервисВМоделиСервисаКлиентСервер.ТекстИсключенияУказанНеВерныйВременныйПароль()) > 0 Тогда
