...
&НаСервере
Процедура ЗаписьОшибкуРаботыСФайлами(ПодробноеПредставлениеОшибки, ТекстСообщения)
...
Процедура ОткрытьИПрочитатьФайл(Команда)
	...
	Исключение
		...
		ЗаписьОшибкуРаботыСФайлами(ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()), ТекстСообщения);
	КонецПопытки;
