...
// Возвращает имена блокируемых реквизитов для подсистемы
		 ...
		 ИЛИ СоответствиеСсылок.Количество() > 0 Тогда
			...
			Если Свойство <> СвойствоОбъект.Ссылка Тогда
				...
				Если КорневойНабор <> Неопределено Тогда
					Если ЗначениеЗаполнено(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(КорневойНабор, "ЭтоГруппа")) = Истина Тогда
