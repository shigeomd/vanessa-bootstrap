...
Процедура ТекстПриглашенияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ЗаголовокФормы = НСтр("ru='Текст для приглашения контрагента'");
...
Процедура ЗаполнитьМаркер(ОбработчикОповещения)
	...
	ЭлектронныеДокументыСлужебныйКлиент.ПолучитьCоответствиеСоглашенийИПараметровСертификатов(ОбработчикОповещения, Массив);
