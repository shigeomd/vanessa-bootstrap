...
// Возвращает список реквизитов, которые можно редактировать
...
Функция ПоставляемыеНастройкиПрограмм(ТолькоДляНачальногоЗаполнения = Ложь) Экспорт
	...
	Если Не ТолькоДляНачальногоЗаполнения Тогда
	...
	Если ТолькоДляНачальногоЗаполнения Тогда
		Возврат Настройки;
	КонецЕсли;
...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ПоставляемыеНастройки = ПоставляемыеНастройкиПрограмм(Истина);
