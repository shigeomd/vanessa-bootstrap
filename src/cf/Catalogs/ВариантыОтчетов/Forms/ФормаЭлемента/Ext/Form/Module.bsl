...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПравоНаЭтотВариант = ПолныеПраваНаВарианты Или Объект.Автор = Пользователи.ТекущийПользователь();
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	ПерезаполнитьДерево(Ложь);
	СтандартныеПодсистемыКлиентСервер.РазвернутьУзлыДерева(ПараметрыЗаписи, "ДеревоПодсистем", "*", Истина);
КонецПроцедуры
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	СтандартныеПодсистемыКлиент.ПоказатьРезультатВыполнения(ЭтотОбъект, ПараметрыЗаписи);
КонецПроцедуры
