...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОпределитьПолномочиеВТаблице("01", "подписывать налоговую декларацию, др. отчетность");
	ОпределитьПолномочиеВТаблице("02", "представлять налоговую декларацию, др. отчетность");
	ОпределитьПолномочиеВТаблице("03", "получать документы в инспекции ФНС России");         
	ОпределитьПолномочиеВТаблице("04", "вносить изменения в документы налоговой отчетности");
	ОпределитьПолномочиеВТаблице("05", "подписывать документы, используемые при постановке и снятии с учета и сообщении сведений, установленных НК РФ (за исключением документов, используемых при  учете и контроле банковских счетов)");
	ОпределитьПолномочиеВТаблице("06", "представлять документы, используемые при постановке и снятии с учета и сообщении сведений, установленных НК РФ (за исключением документов,  используемых при  учете и контроле банковских счетов)");
	ОпределитьПолномочиеВТаблице("07", "получать от налогового органа документы, подтверждающие постановку и снятие с учета");
	ОпределитьПолномочиеВТаблице("08", "подписывать документы, используемые при  учете и контроле банковских счетов");
	ОпределитьПолномочиеВТаблице("09", "представлять документы, используемые при  учете и контроле банковских счетов");
	ОпределитьПолномочиеВТаблице("10", "представлять документы по применению специальных налоговых режимов и консолидации учета по обособленным подразделениям");
	ОпределитьПолномочиеВТаблице("11", "получать в инспекции ФНС России документы по применению специальных налоговых режимов и консолидации учета по обособленным подразделениям");
	ОпределитьПолномочиеВТаблице("12", "подписывать документы по консолидации учета по обособленным подразделениям");
	ОпределитьПолномочиеВТаблице("13", "представлять заявления и запросы на проведение сверки расчетов с бюджетом, получение справок о состоянии расчетов с бюджетом");
	ОпределитьПолномочиеВТаблице("14", "получать в инспекции ФНС России акты сверок и справки о состоянии расчетов с бюджетом");
	ОпределитьПолномочиеВТаблице("15", "подписывать акт сверки расчетов с бюджетом");
	ОпределитьПолномочиеВТаблице("16", "подписывать акт и решение налоговой проверки");
	ОпределитьПолномочиеВТаблице("17", "подписывать заявление на зачет/возврат налога");
	ОпределитьПолномочиеВТаблице("18", "подписывать заявления о ввозе товаров и уплате косвенных налогов");
	ОпределитьПолномочиеВТаблице("19", "получать заявления о ввозе товаров и уплате");
