...
Процедура ОбновитьЭлементСправочника(ИмяПредопределенныхДанных, Наименование)
	...
	СсылкаПредопределенного = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ОснованияДосрочногоНазначенияПенсииДляСЗВК." + ИмяПредопределенныхДанных);
