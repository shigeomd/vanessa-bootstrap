...
Процедура ЗагрузитьРезультат()
	...
	Если ПараметрыЗагрузкиКлассификатора["ЗагрузкаВыполнена"] Тогда
		//ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(ИмяСобытия,, // БСП 2.2
...
Процедура ПолучитьСортировщикДискИТС(ПараметрыЗагрузкиФайловИТС)
	...
	#Иначе
		...
		ПараметрыЗагрузкиФайловИТС.Вставить("ТекстСообщения", НСтр("ru ='В веб-клиенте загрузка классификатора банков недоступна.'"));
