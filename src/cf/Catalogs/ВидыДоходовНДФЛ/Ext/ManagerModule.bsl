...
Процедура ЗаполнитьКодыДоходов2014() Экспорт 
	...
	ОписатьКодДоходаНДФЛ("Код1532", Ставка13, "1532", "Доходы, полученные по операциям с финансовыми инструментами срочных сделок, базисным активом по которым являются ценные бумаги или фондовые индексы", Ложь, Ложь, ВычетыНДФЛ.Код205);
	ОписатьКодДоходаНДФЛ("Код1533", Ставка13, "1533", "Доходы от операций с финансовыми инструментами срочных сделок, не обращающимися на организованном рынке ценных бумаг", Ложь, Ложь, ВычетыНДФЛ.Код220);
	ОписатьКодДоходаНДФЛ("Код1535", Ставка13, "1535", "Доходы, полученные по операциям с финансовыми инструментами срочных сделок, базисным активом которых не являются ценные бумаги или фондовые индексы", Ложь, Ложь, ВычетыНДФЛ.Код207);
	...
	ОписатьКодДоходаНДФЛ("Код1543", Ставка13, "1543", "Доходы по операциям, учитываемым на индивидуальном инвестиционном счете",Ложь,Истина, ВычетыНДФЛ.Код221);
