...
Процедура ОбработкаСправочникаДляУправленияПредопределеннымиЗначениями() Экспорт
	...
	Если ПредопределенныйЭлемент("УслугиКомиссионеров") = Неопределено Тогда
		...
		|	ВЫБОР
		|		КОГДА ОтчетКомиссионераОПродажах.Субконто1 ССЫЛКА Справочник.СтатьиЗатрат
		|			ТОГДА ВЫРАЗИТЬ(ОтчетКомиссионераОПродажах.Субконто1 КАК Справочник.СтатьиЗатрат)
		|		КОГДА ОтчетКомиссионераОПродажах.Субконто2 ССЫЛКА Справочник.СтатьиЗатрат
		|			ТОГДА ВЫРАЗИТЬ(ОтчетКомиссионераОПродажах.Субконто2 КАК Справочник.СтатьиЗатрат)
		|		КОГДА ОтчетКомиссионераОПродажах.Субконто3 ССЫЛКА Справочник.СтатьиЗатрат
		|			ТОГДА ВЫРАЗИТЬ(ОтчетКомиссионераОПродажах.Субконто3 КАК Справочник.СтатьиЗатрат)
		...
		|ГДЕ
		|	ОтчетКомиссионераОПродажах.Субконто1 ССЫЛКА Справочник.СтатьиЗатрат
		|	ИЛИ ОтчетКомиссионераОПродажах.Субконто2 ССЫЛКА Справочник.СтатьиЗатрат
		|	ИЛИ ОтчетКомиссионераОПродажах.Субконто3 ССЫЛКА Справочник.СтатьиЗатрат
		|
		|УПОРЯДОЧИТЬ ПО
