...
Функция СформироватьСтрокуПредставленияФайлов(КоличествоФайлов)
	...
	РезультатСтрокой = СтрЗаменить(ЧислоПрописью(КоличествоФайлов, "Л = ru_RU; НП=Истина, НД=Ложь", "файл, файла, файлов, м, , , , ,0"),
								ЧислоПрописью(КоличествоФайлов, "Л = ru_RU; НП=Ложь, НД=Ложь", " , , , , , , , ,0"),
								"");
	
	Возврат Формат(КоличествоФайлов, "ЧН=0; ЧГ=0") + " " + РезультатСтрокой;
