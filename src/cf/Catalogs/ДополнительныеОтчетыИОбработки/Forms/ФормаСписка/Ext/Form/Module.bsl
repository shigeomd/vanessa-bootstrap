...
Процедура УстановитьУсловноеОформление()
	Инструкция = ДополнительныеОтчетыИОбработки.ИнструкцияУсловногоОформления();
	...
	ДополнительныеОтчетыИОбработки.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
