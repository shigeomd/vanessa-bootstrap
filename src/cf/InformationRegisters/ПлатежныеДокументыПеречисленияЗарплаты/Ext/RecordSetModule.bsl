...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Не ЭтотОбъект.ДополнительныеСвойства.Свойство("ВыполнятьПроверкуПередЗаписьюНабора") Или 
		ЭтотОбъект.ДополнительныеСвойства.ВыполнятьПроверкуПередЗаписьюНабора Тогда
