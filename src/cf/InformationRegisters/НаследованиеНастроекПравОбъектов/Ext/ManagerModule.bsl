...
//
//  ОбъектыСИзменениями  - только для внутреннего использования.
//
Процедура ОбновитьРодителейВладельца(ВладелецНастроекПрав, ЕстьИзменения, ОбновитьИерархию = Ложь, ОбъектыСИзменениями = Неопределено) Экспорт
...
Процедура ОбновитьИерархиюВладельца(Ссылка, ЕстьИзменения, ОбъектыСИзменениями) Экспорт
