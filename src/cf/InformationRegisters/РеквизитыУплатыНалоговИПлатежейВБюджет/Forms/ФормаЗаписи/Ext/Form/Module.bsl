...
Процедура ЗаполнитьСпискиРеквизитовПлатежейВБюджет()
	...
	РабочаяДатаСеанса = ОбщегоНазначенияБП.ПолучитьРабочуюДату();
...
Процедура УправлениеФормой(Форма)
	...
	Если Запись.ВидПеречисленияВБюджет = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.НалоговыйПлатеж") Тогда
		Элементы.ГруппаСтраницыВидаПеречисления.ТекущаяСтраница = Элементы.ГруппаНалоговыйПлатеж;
	ИначеЕсли Запись.ВидПеречисленияВБюджет = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.ТаможенныйПлатеж") Тогда
		Элементы.ГруппаСтраницыВидаПеречисления.ТекущаяСтраница = Элементы.ГруппаТаможенныйПлатеж;
	Иначе
		Элементы.ГруппаСтраницыВидаПеречисления.ТекущаяСтраница = Элементы.ГруппаИнойПлатеж;
	КонецЕсли;
...
#КонецЕсли
	...
	Элементы.ДекорацияПоказательТипа.Видимость = ВидимостьПоказательТипа;
