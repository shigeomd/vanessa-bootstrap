...
Процедура УстановитьОтображениеЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ДекорацияУдалятьПрефиксыОрганизацииИИБИзНомеровКадровыхПриказов",
		"Видимость",
		ПолучитьФункциональнуюОпциюФормы("ИспользоватьКадровыйУчет"));
...
Процедура ДобавитьСтрокиПорядка(Список, ПолноеИмяОбъектаМетаданных, Представление)
	...
	Для каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
		...
		Если Найти(ВРег(Реквизит.Имя), "УДАЛИТЬ") = 1 Тогда
			Продолжить;
		КонецЕсли; 
...
Процедура СформироватьПредставление(Родитель)
	...
	ПозицияСкобки = Найти(Родитель.Представление, "(");
