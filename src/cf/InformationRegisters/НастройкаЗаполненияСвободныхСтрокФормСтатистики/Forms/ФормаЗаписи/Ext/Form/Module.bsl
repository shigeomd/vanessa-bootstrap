...
Процедура ОтборыПравоеЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	КомпоновкаДанныхКлиент.ОтборыПравоеЗначениеНачалоВыбора(Настройки, ЭтаФорма, Элемент, ДанныеВыбора, СтандартнаяОбработка, СписокПараметров);
...
Процедура ИнициализироватьНастройки()
	...
	// Установим параметры выбра Детализации объекта наблюдения
	ПараметрыВыбора	= Новый Массив();
	ПараметрыВыбора.Добавить(Новый ПараметрВыбора("ДанныеКлассификатораОтбор", Запись.ОбъектНаблюдения.Детализация));
