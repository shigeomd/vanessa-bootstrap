...
Процедура ДобавитьТранспортныйКонтейнерПослеУстановкиРасширенияРаботыСФайламиЗавершение(Результат, АдресКонтейнераВоВременномХранилище, ПолноеИмяФайлаФайла, ДополнительныеПараметры) Экспорт
	...
	Если КоличествоТранспортныхКонтейнеров > 0 Тогда
		...
		Если КонтейнерСТемЖеИменемСуществует Тогда
			...
			ДополнительныеПараметры = Новый Структура("КоличествоТранспортныхКонтейнеров, КонтейнерСТемЖеИменемСуществует, ТранспортноеСообщение, ОбъектФайл, АдресКонтейнераВоВременномХранилище", 
				КоличествоТранспортныхКонтейнеров, КонтейнерСТемЖеИменемСуществует, ТранспортноеСообщение, ОбъектФайл, АдресКонтейнераВоВременномХранилище);
