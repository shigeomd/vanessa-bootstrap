...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат "Настройки обмена РТ1-БП3";
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки = "") Экспорт
	...
	Возврат НСтр("ru = 'Синхронизация в одностороннем порядке,
	|между конфигурацией Розница ред. 1 и Бухгалтерия предприятия ред. 3.'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = 'Розница, ред. 1.0'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурацией Розница ред. 1 и Бухгалтерия Предприятия ред. 3.
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	Возврат "ПланОбмена.ОбменРозница1Бухгалтерия3.Форма.ПодробнаяИнформация";
