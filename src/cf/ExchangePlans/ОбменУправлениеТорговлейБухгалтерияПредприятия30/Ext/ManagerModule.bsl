...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат "Настройки обмена для информационной базы Управление торговлей ред. 11.1";
...
Функция КраткаяИнформацияПоОбмену(IDНастройки = "") Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурациями ""Бухгалтерия предприятия"", ред. 3, и ""Управление торговлей"", ред. 11.
...
Функция ПараметрыЗапускаСинхронизацииДанных(УзелИнформационнойБазы) Экспорт
	...
	//руктураРеквизитов = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(УзелИнформационнойБазы, "ПравилаОтправкиДокументов, ПравилаОтправкиСправочников");
