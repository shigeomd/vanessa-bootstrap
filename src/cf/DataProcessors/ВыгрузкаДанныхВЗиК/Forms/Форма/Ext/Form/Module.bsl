...
Процедура УстановитьПометкиПодчиненных(ИмяПравила)
	...
	Для Каждого РедактируемаяСтрока ИЗ РедактируемыеСтроки Цикл
		Если РедактируемаяСтрока <> Неопределено Тогда
			Обработки.ВыгрузкаДанныхВЗиК.УстановитьЗначениеСтрокиДерева(РедактируемаяСтрока.Строки, ТаблицаПравилВыгрузки, РедактируемаяСтрока.Включить);
		КонецЕсли;		
	КонецЦикла;
...
Процедура СнятьУстановитьВсеФлажки(Включить)
	...
	Для Каждого РедактируемаяСтрока ИЗ ТаблицаПравилВыгрузки.Строки Цикл
		...
		Обработки.ВыгрузкаДанныхВЗиК.УстановитьЗначениеСтрокиДерева(РедактируемаяСтрока.Строки, ТаблицаПравилВыгрузки, Включить);		
	КонецЦикла;
...
Функция ВыполнитьВыгрузкуДанныхНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Выгрузка данных в ЗиК'");
	
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		УникальныйИдентификатор,
		"Обработки.ВыгрузкаДанныхВЗиК.ВыгрузитьДанные", 
		ПараметрыВыгрузки, 
		НаименованиеЗадания);
