...
Процедура ЗагрузитьДанныеВИБ(ПараметрыВыгрузки, АдресХранилища) Экспорт
	...
	ТекстСообщения = "";
	Если Найти(СодержимоеДок, "БухгалтерияПредприятия 3.0") = 0 
		И Найти(СодержимоеДок, "БухгалтерияПредприятияКОРП 3.0") = 0 Тогда
	...
	Если ТекстСообщения <> "" Тогда
		Если Найти(СодержимоеДок, "ЗарплатаИУправлениеПерсоналом") <> 0 Тогда
