...
//Функция ПолучитьСодержаниеКлассификатора()
...
Процедура ЗаписатьКоллекциюВСправочник(Коллекция,
	...
	// Константы
	Пробелы = "                                                  "; // 50 пробелов (для дополнения до длины кода)
...
//
Процедура ЗаписатьКлассификаторы(НомерСтроки=1,Прогресс = 0) Экспорт
	
	//Классификатор = Классификаторы[НомерСтроки-1];	
...
Функция ПроверитьРазархивироватьФайл(Файл, ТипЧитателя, ПервичныйИсточник, УникальныйИдентификатор, MIMEТип = "")
	...
	ИначеЕсли НРег(Файл.Расширение) = ".zip"
		...
		Для Каждого Элемент Из Zip.Элементы Цикл
			...
			ДобавитьКлассификатор(НовыйФайл, УникальныйИдентификатор, ПервичныйИсточник);
		КонецЦикла;
...
// Процедура ДобавитьНовыйКлассификатор()
Процедура ДобавитьНовыйКлассификатор(ИмяФайла,Хранение,УникальныйИдентификатор) Экспорт
	...
	Иначе
		РабФайл = Файл;
	КонецЕсли;
    ДобавитьКлассификатор(РабФайл, УникальныйИдентификатор, РабФайл.ПолноеИмя);
КонецПроцедуры // ДобавитьНовыйКлассификатор()

//Функция ДобавитьКлассификатор()
Функция ДобавитьКлассификатор(СтрокаXMLИлиФайл, УникальныйИдентификатор, ПервичныйИсточник = "", MIMEТип = "") Экспорт
	...
	ПервичныйИсточник, УникальныйИдентификатор, MIMEТип);
