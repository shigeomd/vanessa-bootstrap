...
Процедура СформироватьОперациюПоУстановкеСубконтоПартии(СтруктураПараметров, Отказ)
	...
	ТекстКомментария = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Нстр("ru = '#Создан автоматически обработкой ""Установка субконто ""Партии"" при переходе на партионный учет"", дата создания - %1'"), ТекущаяДата());
