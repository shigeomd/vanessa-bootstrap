...
Функция ОбъектМетаданных(Знач ПолноеИмя)
	...
	Если ОбъектМетаданных = Неопределено Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'В текущей конфигурации отсутствует объект метаданных %1, присутствующих в файле данных!'"),
			ПолноеИмя
		);
...
Функция Вершина(Знач ОбъектМетаданых, Знач ИсключениеПриОтсутствии = Истина)
	...
	ИначеЕсли Строки.Количество() = 0 Тогда
		...
		Если ИсключениеПриОтсутствии Тогда
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'В графе отсутствует вершина для объекта метаданных %1!'"),
	...
	Иначе
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Нарушение уникальности граф для объекта метаданных %1!'"),
			ОбъектМетаданых.ПолноеИмя());
