...
&НаКлиенте
Процедура ДекорацияОбработкаЗапросовЗаголовокОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылка, СтандартнаяОбработка)
	
	Если НавигационнаяСсылка = "internal://sm" Тогда
		
		СтандартнаяОбработка = Ложь;
		ПерейтиПоНавигационнойСсылке(ВнешнийАдресУправляющегоПриложения + "?N=" + ИмяПользователя() + "&C=PermissionRequest" + Строка(ИдентификаторПакета));
