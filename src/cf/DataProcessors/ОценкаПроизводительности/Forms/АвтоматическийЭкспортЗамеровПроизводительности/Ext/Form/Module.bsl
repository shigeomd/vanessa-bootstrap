...
Процедура ВыбратьКаталогЭкспортаПредложено(РасширениеРаботыСФайламиПодключено, ДополнительныеПараметры) Экспорт
	...
	Если РасширениеРаботыСФайламиПодключено Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ДействиеПослеВыбораКаталогаЭкспорта", ЭтотОбъект);
...
&НаКлиенте
Процедура ДействиеПослеВыбораКаталогаЭкспорта(Результат, ДополнительныеПараметры) Экспорт
	
	Если ЗначениеЗаполнено(Результат) Тогда
		
		ВыбранныйКаталог = Результат;
		ЛокальныйКаталогЭкспорта = Результат;
