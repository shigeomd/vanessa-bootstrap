...
Процедура ДобавитьИдею(Команда)
	...
	ОткрытьФорму("Обработка.ИнформационныйЦентр.Форма.НоваяИдея", ПараметрыФормы, ЭтаФорма);
...
Функция ПолучитьНомерИдеиПоНазванию(Знач ИмяЭлемента)
	...
	МассивЭлементов = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(ИмяЭлемента, "_");
