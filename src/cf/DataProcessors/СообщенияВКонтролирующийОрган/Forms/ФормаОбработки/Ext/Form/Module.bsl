...
Процедура ЗаполнитьДерево()
	...
	Сообщение = КорневойУровень.Добавить();
	Сообщение.Наименование = "Участие в российских и иностранных организациях";
	Сообщение.ИндексКартинки = 1;
	Сообщение.UID = Новый УникальныйИдентификатор;
	СоответствиеУИД[Сообщение.UID] = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаС09_2;
