...
Функция СформироватьПечатнуюФормуСправкиРублевыеСуммыДокументаВВалюте(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_РублевыеСуммыДокументаВВалюте";
...
Процедура ЗаполнитьТабличныйДокументСправки(ТабличныйДокумент, ВыборкаДокументов, ВыборкаСуммПоДокументам, ЕстьПредоплаты, ВыборкаПредоплат, ВалютаРегламентированногоУчета, Макет)
	...
	КурсДокумента 	   = ВыборкаДокументов.КурсВзаиморасчетов / ?(ВыборкаДокументов.КратностьВзаиморасчетов <> 0, ВыборкаДокументов.КратностьВзаиморасчетов, 1);
	...
	Иначе
		...
		Если УчетАгентскогоНДС Тогда
			...
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_5 = НСтр("ru=""Неоплачено по документу в валюте (без НДС) (1.1) - (1.2)""");
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_7 = НСтр("ru=""Неоплачено по документу, руб. (без НДС) (1.5) * (1.6)""");
		...
		Иначе
			...
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_4 = НСтр("ru=""Средний курс валюты по зачтенной предоплате - справочно  (1.3) / (1.2)""");
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_5 = НСтр("ru=""Неоплачено по документу в валюте  (1.1) - (1.2)""");
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_7 = НСтр("ru=""Неоплачено по документу, руб. (1.5) * (1.6)""");
			ОбластьПоказатели.Параметры.ЗаголовокДляСтроки1_8 = НСтр("ru=""Сумма документа, руб. (1.3) + (1.7)""");
	...
	Если ВыборкаДокументов.РасчетыВУсловныхЕдиницах или ВыборкаДокументов.УчетАгентскогоНДС Тогда
