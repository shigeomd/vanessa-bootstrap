...
&НаКлиенте
Процедура Подключаемый_ПолеАвтоПодбор(Элемент, Текст, ДанныеВыбора, Параметры, Ожидание, СтандартнаяОбработка)
...
Функция РезультатВыбора()
	...
	Для каждого ЧастьАдреса Из ЧастиАдреса Цикл
		Если ЧастьАдреса.Значение.Уровень > УровеньИдентификатора И ЗначениеЗаполнено(ЧастьАдреса.Значение.Идентификатор) Тогда
			УровеньИдентификатора = ЧастьАдреса.Значение.Уровень;
			Идентификатор = ЧастьАдреса.Значение.Идентификатор;
		КонецЕсли;
	КонецЦикла;
	Если ЗначениеЗаполнено(Идентификатор) Тогда
		Результат.Вставить("Идентификатор", Идентификатор);
	Иначе
		Результат.Вставить("Идентификатор", УправлениеКонтактнойИнформациейСлужебный.ИдентификаторНаселенногоПунктаПоЧастямАдреса(ЧастиАдреса));
	КонецЕсли;
