...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДеревоДляВычислений = ДанныеФормыВЗначение(Сертификаты, Тип("ДеревоЗначений"));
...
Процедура ПриОткрытии(Отказ)
	...
	ДокументооборотСКОКриптографияКлиент.НайтиСертификаты(ОписаниеОповещения, СертификатыСоответствие);
