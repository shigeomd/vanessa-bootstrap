...
Процедура СохранитьНастройки()
	...
	Если Элементы.ФлажокПодтверждениеОтправки.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьПодтверждениеОтправки", , ПечататьПодтверждениеОтправки);
	КонецЕсли;
	
	Если Элементы.ФлажокИзвещениеОбОтказеПФР.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьИзвещениеОбОтказеПФР", , ПечататьИзвещениеОбОтказеПФР);
	КонецЕсли;
	
	Если Элементы.ФлажокПротокол.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьПротокол", , ПечататьПротокол);
	КонецЕсли;
	
	Если Элементы.ФлажокУведомлениеОбУточнении.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьУведомлениеОбУточнении", , ПечататьУведомлениеОбУточнении);
	КонецЕсли;
	
	Если Элементы.ФлажокПротоколПриема2НДФЛ.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьПротоколПриема2НДФЛ", , ПечататьПротоколПриема2НДФЛ);
	КонецЕсли;
	
	Если Элементы.ФлажокРеестрСведений2НДФЛ.Доступность Тогда
		ХранилищеОбщихНастроек.Сохранить("НастройкиГрупповойПечатиЦикловОбмена_ПечататьРеестрСведений2НДФЛ", , ПечататьРеестрСведений2НДФЛ);
	КонецЕсли;
