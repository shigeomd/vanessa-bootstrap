...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	
	//	Элементы.ПанельПредставление.ТекущаяСтраница = Элементы.СтраницаXML;
	//	
	...
	//	//ОбъектЗаписьТекста.Закрыть();
	//	//
	//	//Элементы.ПредставлениеXML.Перейти(ИмяВременногоФайлаВыгрузки);
	//	
	//Иначе
	//	Элементы.ПанельПредставление.ТекущаяСтраница = Элементы.СтраницаТекст;
	//КонецЕсли;
...
Процедура КомандаСохранитьПротоколПроверки(Команда)
	...
	ДокументооборотСКООперацииСФайламиКлиент.СохранитьФайлы(СохраняемыеФайлы);
