...
Функция КодРезультатаСверкиПоСтрокеРезультата(СтрокаРезультата)
	...
	Если Найти(СтрокаРезультата, "FAM") <> 0 Тогда
		Возврат 1;
	ИначеЕсли Найти(СтрокаРезультата, "NAM") <> 0 Тогда
		Возврат 2;
	ИначеЕсли Найти(СтрокаРезультата, "PTR") <> 0 Тогда
		Возврат 3;
	ИначеЕсли Найти(СтрокаРезультата, "FIO") <> 0 Тогда
		Возврат 4;
	Иначе
