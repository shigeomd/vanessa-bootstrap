...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	КонецЕсли;
	Параметры = Новый Структура("КлючВарианта", "РасчетныйЛисток");
	ОткрытьФорму("Отчет.АнализНачисленийИУдержаний.ФормаОбъекта", Параметры, Источник, Уникальность, ВариантОткрытияОкнаФормы);
КонецПроцедуры
