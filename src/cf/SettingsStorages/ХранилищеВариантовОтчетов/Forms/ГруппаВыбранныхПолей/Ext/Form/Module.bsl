...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("Расположение", Расположение) Тогда
		ВызватьИсключение НСтр("ru = 'Не передан служебный параметр ""Отображение"".'");
	КонецЕсли;
	...
	Иначе
		ВызватьИсключение СтрЗаменить(НСтр("ru = 'Некорретное значение параметра ""Расположение"": ""%1"".'"), "%1", Строка(Расположение));
	КонецЕсли;
КонецПроцедуры
