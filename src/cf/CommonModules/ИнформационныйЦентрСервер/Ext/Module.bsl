...
Функция СформироватьЗаголовокКомментариев(Знач ПредставлениеИдеи) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Комментарии: %1'"), ПредставлениеИдеи.CommentsCount);
...
Функция СформироватьЗаголовокДатыРеализации(Знач ПредставлениеИдеи) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Плановая дата реализации: %1'"), ПредставлениеИдеи.PlanMadeDatePresentation);
...
Функция СформироватьДатуОтклонения(Знач ПредставлениеИдеи) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Отклонено: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция СформироватьДатуРеализации(Знач ПредставлениеИдеи) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Реализовано: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция ПолучитьПроксиСлужбыПоддержки() Экспорт
	...
	ИмяПользователя    = Константы.ИмяПользователяПрограммногоИнтерфейсаСлужбыПоддержки.Получить();
	ПарольПользователя = Константы.ПарольПользователяПрограммногоИнтерфейсаСлужбыПоддержки.Получить();
	УстановитьПривилегированныйРежим(Ложь);
