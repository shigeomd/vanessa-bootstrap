...
Функция ПараметрыДистрибутива(Знач ИмяФайла) Экспорт
	...
	Для НомерСтроки = 1 По ТекстовыйДокумент.КоличествоСтрок() Цикл
		...
		Если ПустаяСтрока(ВременнаяСтрока) Тогда
			Продолжить;
		КонецЕсли; 
		Если Найти(ВременнаяСтрока,"fromversions=")>0 Тогда
		...
		ИначеЕсли Найти(ВременнаяСтрока,"updatedate=")>0 Тогда
			...
			Если СтрДлина(ВременнаяСтрока)>8 Тогда
				Если Найти(ВременнаяСтрока,".")=5 Тогда
					// дата в формате  ГГГГ.ММ.ДД
					ВременнаяСтрока = СтрЗаменить(ВременнаяСтрока,".","");
				ИначеЕсли Найти(ВременнаяСтрока,".")=3 Тогда
