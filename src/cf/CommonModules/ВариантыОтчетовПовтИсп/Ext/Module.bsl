...
Функция ОтчетыСНастройками() Экспорт
	ЗначениеКонстанты = Константы.ПараметрыВариантовОтчетов.Получить();
	ОтчетыСНастройками = ЗначениеКонстанты.Получить().ОтчетыСНастройками;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ДополнительныеОтчетыИОбработки") Тогда
		МодульДополнительныеОтчетыИОбработки = ОбщегоНазначения.ОбщийМодуль("ДополнительныеОтчетыИОбработки");
		МодульДополнительныеОтчетыИОбработки.ПриОпределенииОтчетовСНастройками(ОтчетыСНастройками);
	КонецЕсли;
	
	Возврат ОтчетыСНастройками;
КонецФункции
