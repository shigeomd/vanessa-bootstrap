...
//
Функция ОбновитьВерсиюФайла(ФайлСсылка, СведенияОФайле, ВерсияСсылка = Неопределено, УникальныйИдентификаторФормы = Неопределено)
...
//
Функция ДанныеФайлаИНавигационнаяСсылкаВерсииВоВременномХранилище(ФайлИлиВерсияСсылка, ИдентификаторФормы) Экспорт
	...
	КонецЕсли;
	НавигационнаяСсылкаВерсии = ПолучитьНавигационнуюСсылкуВоВременномХранилище(ВерсияСсылка, ИдентификаторФормы);
	Результат = Новый Структура("ДанныеФайла, НавигационнаяСсылкаВерсии", ДанныеФайла, НавигационнаяСсылкаВерсии);
	Возврат Результат;
КонецФункции
