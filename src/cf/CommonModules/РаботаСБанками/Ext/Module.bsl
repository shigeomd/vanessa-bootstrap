...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	ВыводитьОповещениеОНеактуальности = (
		...
		И Не АвтономнаяРаботаСлужебный.ЭтоАвтономноеРабочееМесто() // В Автономном рабочем месте обновляется автоматически.
		И ПравоДоступа("Изменение", Метаданные.Справочники.КлассификаторБанковРФ) // Пользователь с необходимыми правами.
		И ОбщегоНазначения.ИнформационнаяБазаФайловая() // Классификатор не обновляется автоматически.
...
Процедура ПолучитьДанныеРБК(ПараметрыЗагрузкиКлассификатора, АдресХранилища = "") Экспорт
	...
	ПараметрыЗагрузкиФайловРБК.Вставить("СписокИзмененныхБанков", Новый СписокЗначений);
	...
	РаботаСБанкамиПереопределяемый.ОбновитьБанкиИзКлассификатора(
			ПараметрыЗагрузкиФайловРБК["СписокИзмененныхБанков"], 0);
...
Процедура ЗагрузитьДанныеРБК(ПараметрыЗагрузкиФайловРБК) Экспорт
	...
	ПараметрыЗагрузкиДанныхРБК.Вставить("СписокИзмененныхБанков", ПараметрыЗагрузкиФайловРБК["СписокИзмененныхБанков"]);
	...
	ПараметрыЗагрузкиФайловРБК.Вставить("СписокИзмененныхБанков", ПараметрыЗагрузкиДанныхРБК["СписокИзмененныхБанков"]);
КонецПроцедуры 
...
Процедура ЗагрузитьДанныеДискИТС(ПараметрыЗагрузкиФайловИТС) Экспорт
	...
	Для НомерЧасти = 1 По КоличествоЧастей Цикл	
		...
		ПараметрыЗагрузкиДанныхИТС.Вставить("СписокИзмененныхБанков",
			?(ПараметрыЗагрузкиФайловИТС["СписокИзмененныхБанков"] = Неопределено, Новый Массив, ПараметрыЗагрузкиФайловИТС["СписокИзмененныхБанков"]));
		...
		ПараметрыЗагрузкиФайловИТС.Вставить("СписокИзмененныхБанков", ПараметрыЗагрузкиДанныхИТС["СписокИзмененныхБанков"]);
...
Процедура ЗаписатьДанныеКлассификатора(ПараметрыЗагрузкиДанныхИТС)
	...
	ПараметрыЗагрузкиДанных.Вставить("СписокИзмененныхБанков", ПараметрыЗагрузкиДанныхИТС["СписокИзмененныхБанков"]);
	...
	ПараметрыЗагрузкиДанныхИТС.Вставить("СписокИзмененныхБанков", ПараметрыЗагрузкиДанных["СписокИзмененныхБанков"]);
