...
Процедура ОтправитьПоЭлектроннойПочте(КомандыОтправки, АдресКомандОтправки, ОбъектыОтправки, ЕстьОшибки,
	...
	Для Каждого Команда Из КомандыОтправки Цикл
		...
		ОписаниеКоманды = ОписаниеКомандыОтправки(Команда, АдресКомандОтправки);
...
//
Процедура ОтправитьОтчет(Отчет) Экспорт
...
Функция ОписаниеКомандыОтправки(ИмяКоманды, АдресКомандПечатиВоВременномХранилище)
	
	Возврат ОтправкаПочтовыхСообщенийКлиентПовтИсп.ОписаниеКомандыОтправки(ИмяКоманды, АдресКомандПечатиВоВременномХранилище);
