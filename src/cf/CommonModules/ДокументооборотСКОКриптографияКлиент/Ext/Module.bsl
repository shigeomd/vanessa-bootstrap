...
//
Процедура СоздатьМенеджерКриптографии(ОповещениеОЗавершении, ВыводитьСоообщения = Истина, ПараметрыМодуляКриптографии = Неопределено) Экспорт
	
	ДокументооборотСКОКриптографияСлужебныйКлиент.СоздатьМенеджерКриптографии(
		ОповещениеОЗавершении, ВыводитьСоообщения, ПараметрыМодуляКриптографии);
...
//
Процедура ПолучитьКриптопровайдеры(ОповещениеОЗавершении, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПолучитьКриптопровайдеры(ОповещениеОЗавершении, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ПолучитьАлгоритмы(ОповещениеОЗавершении, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПолучитьАлгоритмы(ОповещениеОЗавершении, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ПолучитьКонтейнерыКлючей(ОповещениеОЗавершении, ПолучатьУникальныеИмена = Ложь, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПолучитьКонтейнерыКлючей(
...
Функция СгенерироватьИмяКонтейнера(ОсноваИмени) Экспорт
	...
	Возврат ДокументооборотСКОКриптографияСлужебныйКлиент.СгенерироватьИмяКонтейнера(ОсноваИмени);
...
Процедура СоздатьКонтейнерКлючей(ОповещениеОЗавершении, ИмяКонтейнераКлючей, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.СоздатьКонтейнерКлючей(ОповещениеОЗавершении, ИмяКонтейнераКлючей, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура СоздатьЗапросНаСертификат(ОповещениеОЗавершении, ТелоЗапросаНаСертификат, ИмяКонтейнераКлючей,
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.СоздатьЗапросНаСертификат(
...
Процедура СвязатьСертификатСКонтейнеромКлючей(ОповещениеОЗавершении, Сертификат, ИмяКонтейнераКлючей,
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.СвязатьСертификатСКонтейнеромКлючей(
...
Процедура УстановитьСертификатВКонтейнерИХранилище(ОповещениеОЗавершении, ИмяФайлаСертификата, ИмяКонтейнераКлючей,
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.УстановитьСертификатВКонтейнерИХранилище(
...
Процедура ПолучитьСертификаты(ОповещениеОЗавершении, ХранилищеСертификатов = Неопределено,
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПолучитьСертификаты(ОповещениеОЗавершении, ХранилищеСертификатов, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ЭкспортироватьСертификатВФайл(ОповещениеОЗавершении, Сертификат, ИмяФайлаИлиРасширение = Неопределено, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ЭкспортироватьСертификатВФайл(
...
Процедура ЭкспортироватьСертификатВBase64(ОповещениеОЗавершении, Сертификат, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ЭкспортироватьСертификатВBase64(ОповещениеОЗавершении, Сертификат, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ИмпортироватьСертификат(ОповещениеОЗавершении, ИмяФайлаСертификата, ХранилищеСертификатов, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ИмпортироватьСертификат(
...
Процедура ПроверитьСертификат(ОповещениеОЗавершении, Сертификат, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПроверитьСертификат(ОповещениеОЗавершении, Сертификат, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ВыбратьСертификат(ОповещениеОЗавершении, ЭтоЭлектроннаяПодписьВМоделиСервиса, НачальноеЗначениеВыбора = Неопределено, ХранилищеСертификатов = "MY", ПоказыватьПросроченные = Ложь, МножественныйВыбор = Ложь) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ВыбратьСертификат(ОповещениеОЗавершении, ЭтоЭлектроннаяПодписьВМоделиСервиса, НачальноеЗначениеВыбора, ХранилищеСертификатов, ПоказыватьПросроченные, МножественныйВыбор);
...
//  ИмяРеквизитаПредcтавленияСертификата - Строка - имя реквизита представления сертификат.
...
Процедура ОтобразитьПредставлениеСертификата(
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ОтобразитьПредставлениеСертификата(
		ЭтоЭлектроннаяПодписьВМоделиСервиса, 
		ПолеВвода, 
		Сертификат, 
		Форма, 
...
Процедура ОтобразитьПредставленияСертификатов(ПараметрыОтображенияСертификатов, Форма, ЭтоЭлектроннаяПодписьВМоделиСервиса, ВыполняемоеОповещение = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ОтобразитьПредставленияСертификатов(ПараметрыОтображенияСертификатов, Форма, ЭтоЭлектроннаяПодписьВМоделиСервиса, ВыполняемоеОповещение);
...
Процедура НайтиСертификат(ОповещениеОЗавершении, Сертификат, ВыполнятьПроверку = Ложь, ВыводитьСообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.НайтиСертификат(
...
Процедура НайтиСертификаты(ОповещениеОЗавершении, Сертификаты, ВыполнятьПроверку = Ложь, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.НайтиСертификаты(
...
Процедура НайтиСертификатПоОтпечатку(ОповещениеОЗавершении, Отпечаток, ХранилищеСертификатов = Неопределено, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.НайтиСертификатПоОтпечатку(
...
Процедура НайтиСертификатыПоОтпечаткам(ОповещениеОЗавершении, Отпечатки, ХранилищеСертификатов = Неопределено, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.НайтиСертификатыПоОтпечаткам(
...
Процедура ПоказатьСертификат(Сертификат, ФормаВладелец = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПоказатьСертификат(Сертификат, ФормаВладелец);
...
//  МенеджерКриптографии   - AddIn  - объект используемый для работы с криптографией. Если не задан, то будет создан новый.
//
Процедура ПодписатьPKCS7(ОповещениеОЗавершении, Сертификат, ФайлПодписи, ВключатьИсходныеДанные, ИмяФайлаИлиРасширениеИлиАдрес = Неопределено, 
						ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт

	ДокументооборотСКОКриптографияСлужебныйКлиент.ПодписатьPKCS7(
		ОповещениеОЗавершении, Сертификат, ФайлПодписи, ВключатьИсходныеДанные, ИмяФайлаИлиРасширениеИлиАдрес, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ПроверитьПодписьPKCS7(ОповещениеОЗавершении, ФайлПодписи, ФайлДанных,
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПроверитьПодписьPKCS7(
...
Процедура ЗашифроватьPKCS7(ОповещениеОЗавершении, ИсходныйФайл, Сертификаты, ИмяФайлаИлиРасширениеИлиАдрес = Неопределено, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ЗашифроватьPKCS7(
		ОповещениеОЗавершении, ИсходныйФайл, Сертификаты, ИмяФайлаИлиРасширениеИлиАдрес, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура ПодписатьИЗашифроватьPKCS7(ОповещениеОЗавершении, СертификатПодписанта, ИмяФайлаДанных, ВключатьИсходныеДанные, СертификатыПолучателей, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПодписатьИЗашифроватьPKCS7(
...
Процедура РасшифроватьPKCS7(ОповещениеОЗавершении, ЗашифрованныйФайл, ИмяФайлаИлиРасширениеИлиАдрес = Неопределено, Сертификат = Неопределено, 
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.РасшифроватьPKCS7(
...
Процедура ПолучитьПодписантаPKCS7(ОповещениеОЗавершении, ИмяФайлаПодписи, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.ПолучитьПодписантаPKCS7(ОповещениеОЗавершении, ИмяФайлаПодписи, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура Подписать(ОповещениеОЗавершении, Сертификат, ИмяФайлаДанных, ПараметрыКриптографии, ИмяФайлаИлиРасширение = Неопределено, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	ДокументооборотСКОКриптографияСлужебныйКлиент.Подписать(
