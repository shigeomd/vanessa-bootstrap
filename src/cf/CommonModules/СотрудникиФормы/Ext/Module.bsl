...
Процедура ДобавитьКомандуПечатиПриказаОбУвольненииВMSWord(КомандыПечати) Экспорт
	...
	КомандаПечати.МенеджерПечати = "Обработка.ПечатьКадровыхПриказов";
	КомандаПечати.Идентификатор = "ПФ_MXL_Т8";
	КомандаПечати.Представление = НСтр("ru = 'Приказ об увольнении (Word)'");
	КомандаПечати.Порядок = 30;
...
Процедура ДобавитьКомандуПечатиПриказаОПереводеВMSWord(КомандыПечати) Экспорт
	...
	КомандаПечати.МенеджерПечати = "Обработка.ПечатьКадровыхПриказов";
	КомандаПечати.Идентификатор = "ПФ_MXL_Т5";
	КомандаПечати.Представление = НСтр("ru = 'Приказ о переводе (Word)'");
	КомандаПечати.Порядок = 20;
	КомандаПечати.Картинка = БиблиотекаКартинок.ФорматWord2007;
	КомандаПечати.ФорматСохранения = ТипФайлаТабличногоДокумента.DOCX;
...
Процедура ДобавитьКомандуПечатиПриказаОПриемеВMSWord(КомандыПечати) Экспорт
	...
	КомандаПечати.МенеджерПечати = "Обработка.ПечатьКадровыхПриказов";
	КомандаПечати.Идентификатор = "ПФ_MXL_Т1";
	КомандаПечати.Представление = НСтр("ru = 'Приказ о приеме (Word)'");
	КомандаПечати.Порядок = 10;
	КомандаПечати.Картинка = БиблиотекаКартинок.ФорматWord2007;
	КомандаПечати.ФорматСохранения = ТипФайлаТабличногоДокумента.DOCX;
...
Процедура ДобавитьКомандуПечатиСогласияНаОбработкуПерсональныхДанных(КомандыПечати) Экспорт 
	...
	Если Пользователи.РолиДоступны("ПодготовкаСогласияНаОбработкуПерсональныхДанных", , Ложь) Тогда
		...
		КомандаПечати.Обработчик = "СотрудникиКлиент.ОбработкаКомандыСогласиеНаОбработкуПерсональныхДанных";
