...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "1.2.6.3";
	Обработчик.Процедура           = "ЭлектронныеДокументыСлужебный.ПроверитьНепроверенныхКонтрагентов";
...
Процедура ЗаполнитьДанныеОПрофиляхНастроекЭДО() Экспорт
	...
	|	И НЕ ЭДПрисоединенныеФайлы.ВидЭД В (&БанковскиеВидыЭД)
	|
	|СГРУППИРОВАТЬ ПО
	|	СоглашенияОбИспользованииЭДИсходящиеДокументы.ПрофильНастроекЭДО,
	|	ЭДПрисоединенныеФайлы.Ссылка,
	...
	Запрос.УстановитьПараметр("БанковскиеВидыЭД", БанковскиеВидыЭД);
	Выборка = Запрос.Выполнить().Выбрать();	
