...
Процедура ОбновитьИзФайлаНаДиске(ОбработчикРезультата, ДанныеФайла, ИдентификаторФормы) Экспорт
	...
	Диалог.Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Фильтр,
...
Процедура ОсвободитьФайлы(ОбработчикРезультата, ОбъектыСсылка) Экспорт
	...
	// Получение массива данных Файлов.
	ДанныеФайлов = РаботаСФайламиСлужебныйВызовСервера.ДанныеФайла(ОбъектыСсылка);
	ВГраницаМассива  = ДанныеФайлов.ВГраница();
...
Процедура ОткрытьФайлБезРасширенияНапоминание(Контекст)
	...
	Иначе
		ОткрытьФайлБезРасширенияПередачаФайла(, Контекст);
	КонецЕсли;
