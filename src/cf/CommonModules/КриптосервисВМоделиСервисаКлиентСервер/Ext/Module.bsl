...
Функция ЭтоИсключениеОшибкаАвторизации(ИнформацияОбОшибке) Экспорт
	...
	Если Найти(ИнформацияОбОшибке.Описание, ТекстИсключенияНеУказанВременныйПароль()) > 0
		ИЛИ Найти(ИнформацияОбОшибке.Описание, ТекстИсключенияУказанНеВерныйВременныйПароль()) > 0 Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
