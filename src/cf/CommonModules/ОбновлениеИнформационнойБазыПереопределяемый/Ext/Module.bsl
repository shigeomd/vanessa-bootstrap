...
Процедура ПриПолученииПоясненияДляРезультатовОбновленияПрограммы(ТекстПодсказки) Экспорт
	...
	ТекстПодсказки = НСтр("ru='Сведения о результатах обновления версии программы можно также открыть из раздела ""Рабочий стол"" - ""Описание изменений программы"".'");
...
// Устарела. Следует использовать процедуру ПриОтключенииОбработчиковОбновления.
//
...
// Устарела. Следует использовать процедуру ПриПолученииПоясненияДляРезультатовОбновленияПрограммы.
// Переопределяет текст подсказки, указывающий путь к форме "Результаты обновления программы".
//
// Параметры:
//  ТекстПодсказки - Строка - текст подсказки.
