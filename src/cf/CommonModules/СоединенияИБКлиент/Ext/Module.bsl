...
//
Процедура ПриОткрытииФормыОшибкиУстановкиМонопольногоРежима(Оповещение, ПараметрыФормы = Неопределено) Экспорт
...
Функция ЗавершитьВсеСеансыКромеТекущего() Экспорт
