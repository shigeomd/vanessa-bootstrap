...
Процедура ОбработатьНовыеДанные(Знач Дескриптор, Знач ПутьКФайлу) Экспорт
	...
	Если Дескриптор.DataType = "БанкиРФ" И ЗначениеЗаполнено(ПутьКФайлу) Тогда
		Параметры = РаботаСБанками.ЗагрузитьДанныеИзФайлаРБК(ПутьКФайлу);
		
		Если Параметры <> Неопределено Тогда
			РаботаСБанкамиПереопределяемый.РаспространитьБанкиПоОД(Параметры["СписокИзмененныхБанков"],
				Дескриптор.FileGUID, "БанкиРФ");
		КонецЕсли;
	КонецЕсли;
