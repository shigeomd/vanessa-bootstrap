...
//
Процедура ИнициализироватьМеханизмФиксацииРеквизитов(Форма, ТекущийОбъект, ПараметрыФиксацииВторичныхДанных = Неопределено, ОписаниеЭлементовДляПодключенияОбработчикаЗафиксироватьИзменениеРеквизитаВФорме = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ОписаниеЭлементовДляПодключенияОбработчикаЗафиксироватьИзменениеРеквизитаВФорме) Тогда
		ПодключитьОбработчикиФиксацииИзмененийРеквизитов(Форма, ОписаниеЭлементовДляПодключенияОбработчикаЗафиксироватьИзменениеРеквизитаВФорме);
	КонецЕсли;
...
Процедура СоздатьУсловноеОформлениеРеквизитовФормыФикс(Форма)
	...
	Для каждого ОписаниеФиксацииРеквизита Из ПараметрыФиксацииВторичныхДанных.ОписаниеФиксацииРеквизитов Цикл 
		...
		Если НЕ ОписаниеФормы.ФормаРедактируетсяПослеФиксации Тогда
			ЭлементОтбора 					= ГруппаОтбора.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ЭлементОтбора.ВидСравнения 		= ВидСравненияКомпоновкиДанных.Равно;
			ЭлементОтбора.Использование 	= Истина;
...
//    	                                   ФиксацияВторичныхДанныхВДокументахКлиентСервер.ПараметрыФиксацииВторичныхДанных.
//
Процедура ПодключитьОбработчикиФиксацииИзмененийРеквизитов(Форма, ОписаниеЭлементовДляПодключенияОбработчикаЗафиксироватьИзменениеРеквизитаВФорме)
