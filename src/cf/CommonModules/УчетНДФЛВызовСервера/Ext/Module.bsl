...
Функция ПолучитьОписаниеВычета(Вычет, ВключатьКодВычетаВОписание = Ложь) Экспорт
	Если ЗначениеЗаполнено(Вычет) Тогда
		ДанныеВычета = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Вычет, "Наименование, Код");
		Если ВключатьКодВычетаВОписание Тогда
			Возврат ДанныеВычета.Код + " " + ДанныеВычета.Наименование;
		Иначе
			Возврат ДанныеВычета.Наименование;
		КонецЕсли;	
	Иначе
