...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбъектОтчет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)];
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Иначе
		...
		Если Найти(ОбластьИмя, "П00024000200") = 1 Тогда
			СтандартнаяОбработка = Ложь;
			Модифицированность = Истина;
	...
	Иначе
		...
		Если КоличествоЗагруженныхФайлов > 0 Тогда
			...
			Для Каждого ТекИмяФайла Из МассивИменФайлов Цикл
				...
				Если Найти(ВыбИмяФайла, ТекИмяФайла) > 0 Тогда
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012203", "П000400000106");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012204", "П000400000108");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012205", "П000400000110");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012206",
		"П000400000111;П000400000112;П000400000113;П000400000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012207",
		"П000400000111;П000400000112;П000400000113;П000400000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012208", "П000400000114");
	
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012303", "П000400000107");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100012304", "П000400000109");
	
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013003",
		"П000100010003;П000100012003;П000210020503;П000210020603;П000400000106");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013004",
		"П000100010004;П000100012004;П000400000108");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013005",
		"П000100010005;П000100012005;П000400000110");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013006",
		"П000100010006;П000100012006;П000220022403;П000240024403;П000240025003;П000240025603;П000240026203;П000240026803;П000240001001;П000400000111;П000400000113;П000400000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013007",
		"П000100010007;П000100012007;П000230023403;П000240024403;П000240025003;П000240025603;П000240026203;П000240026803;П000240001001;П000400000112;П000400000113;П000400000103");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100013008",
		"П000100010008;П000100012008;П000210021403;П000400000114");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015003",
		"П000100010003;П000100012003;П000210020503;П000210020603;П000400000106;П000100014003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015004",
		"П000100010004;П000100012004;П000400000108;П000100014004");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015005",
		"П000100010005;П000100012005;П000400000110;П000100014005");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015006",
		"П000100010006;П000100012006;П000220022403;П000240024403;П000240025003;П000240025603;П000240026203;П000240026803;П000240001001;П000400000111;П000400000113;П000400000103;П000100014006");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015007",
		"П000100010007;П000100012007;П000230023403;П000240024403;П000240025003;П000240025603;П000240026203;П000240026803;П000240001001;П000400000112;П000400000113;П000400000103;П000100014007");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000100015008",
		"П000100010008;П000100012008;П000210021403;П000400000114;П000100014008");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000210021303", "П000210021003;П000210021103;П000210021203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000210021304", "П000210021004;П000210021104;П000210021204");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000210021305", "П000210021005;П000210021105;П000210021205");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000210021306", "П000210021006;П000210021106;П000210021206");
...
Процедура ПроверкаЗакраскиТитульного()
	...
	Если СокрЛП(ТабличныйДокумент.Области.Период.Значение) = "3" Тогда
		
		ТабличныйДокумент.Области.ПриобретениеУтратаПраваНаПониженныйТариф.Защита = Истина;
		ТабличныйДокумент.Области.ПриобретениеУтратаПраваНаПониженныйТариф.ЦветФона = СтруктураРеквизитовФормы.ЦветБелый;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ПриобретениеУтратаПраваНаПониженныйТариф",
		1, , "Приобретение/утрата права на применение пониженного тарифа", КоллекцияСписковВыбора["КодПриобретенияУтратыПраваНаПониженныйТариф"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ТипКорректировки",
		1, , "Тип корректировки", КоллекцияСписковВыбора["КодыТиповКорректировки"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000210001001",
		2, , "Выбор тарифа", КоллекцияСписковВыбора["КодыТарифов"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000400000102",
		1, , "Выбор основания для доначисления страховых взносов", КоллекцияСписковВыбора["КодыОснованийДоначисления"]);
...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь, СменилсяПризнакПодписанта = Ложь)
	...
	Если (СтруктураРеквизитовФормы.мВПрограммеИзмененаОрганизация)
	 ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ОКВЭД.Значение)) Тогда
	...
	Для НомНовойСтроки = ИсходноеКоличествоСтрокГруппы По ТекущееКоличествоСтрокГруппы Цикл
		...
		Для Каждого Область Из ОбластьДопСтроки.Области Цикл
			...
			Если ОбластьТаблДок.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник Тогда
				...
				ОбластьТаблДок.Имя = Лев(Область.Имя, Найти(Область.Имя, "_")) + Строка(ТекущееКоличествоСтрокГруппы
				                                                                        - НомНовойСтроки + 1);
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора,
	...
	ОткрытьФорму("Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы",
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			// Расчет по гр. 3 - 8 в стр. 122 раздела 1.
			
			Форма.ТабличныйДокумент.Области.П000100012203.Значение = Форма.СтруктураДанныхРаздел1.П000100012203;
			Форма.ТабличныйДокумент.Области.П000100012204.Значение = Форма.СтруктураДанныхРаздел1.П000100012204;
			Форма.ТабличныйДокумент.Области.П000100012205.Значение = Форма.СтруктураДанныхРаздел1.П000100012205;
			Форма.ТабличныйДокумент.Области.П000100012206.Значение = Форма.СтруктураДанныхРаздел1.П000100012206;
			Форма.ТабличныйДокумент.Области.П000100012207.Значение = Форма.СтруктураДанныхРаздел1.П000100012207;
			Форма.ТабличныйДокумент.Области.П000100012208.Значение = Форма.СтруктураДанныхРаздел1.П000100012208;
			
			// Расчет по гр. 3 и 4 в стр. 123 раздела 1.
			
			Форма.ТабличныйДокумент.Области.П000100012303.Значение = Форма.СтруктураДанныхРаздел1.П000100012303;
			Форма.ТабличныйДокумент.Области.П000100012304.Значение = Форма.СтруктураДанныхРаздел1.П000100012304;
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел4" Тогда
		...
		// по гр. 6 в стр. 122 раздела 1.
		// Суммируем значения по гр. 13 раздела 4,
		// при значении кода основания в гр. 3 равном "1".
		СуммаРазд4Гр13СКодом1ВГр3 = 0;
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
		 ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100012206, ОбластьИмя) > 0 Тогда
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы4, ТаблицаБлока);
			ТаблицаБлока = Форма[ТаблицаБлока];
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4" Тогда
		...
		// Вычисление значения, необходимого для расчета
		// по гр. 7 в стр. 122 раздела 1.
		// Суммируем значения по гр. 13 раздела 4,
		// при значении кода основания в гр. 3 равном "2".
		СуммаРазд4Гр13СКодом2ВГр3 = 0;
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
		 ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100012207, ОбластьИмя) > 0 Тогда
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы4, ТаблицаБлока);
			ТаблицаБлока = Форма[ТаблицаБлока];
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел4" Тогда
			...
			Форма.СтруктураДанныхРаздел1.П000100012203 = Форма.ТабличныйДокумент.Области.П000400000206.Значение;
			Форма.СтруктураДанныхРаздел1.П000100012204 = Форма.ТабличныйДокумент.Области.П000400000208.Значение;
			Форма.СтруктураДанныхРаздел1.П000100012205 = Форма.ТабличныйДокумент.Области.П000400000210.Значение;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			 ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000400000211, ОбластьИмя) > 0
			 ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100012206, ОбластьИмя) > 0 Тогда
				
				Форма.СтруктураДанныхРаздел1.П000100012206
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			 ...
			 ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100012207, ОбластьИмя) > 0 Тогда
				...
				Форма.СтруктураДанныхРаздел1.П000100012207
					= Форма.ТабличныйДокумент.Области.П000400000212.Значение + СуммаРазд4Гр13СКодом2ВГр3;
				
			КонецЕсли;
			
			Форма.СтруктураДанныхРаздел1.П000100012208 = Форма.ТабличныйДокумент.Области.П000400000214.Значение;
			Форма.СтруктураДанныхРаздел1.П000100012303 = Форма.ТабличныйДокумент.Области.П000400000207.Значение;
			Форма.СтруктураДанныхРаздел1.П000100012304 = Форма.ТабличныйДокумент.Области.П000400000209.Значение;
			
		Иначе
			
			Форма.СтруктураДанныхРаздел1.П000100012203 = Форма.СтруктураДанныхРаздел4.П000400000206;
			Форма.СтруктураДанныхРаздел1.П000100012204 = Форма.СтруктураДанныхРаздел4.П000400000208;
			Форма.СтруктураДанныхРаздел1.П000100012205 = Форма.СтруктураДанныхРаздел4.П000400000210;
			Форма.СтруктураДанныхРаздел1.П000100012206
			...
			Форма.СтруктураДанныхРаздел1.П000100012208 = Форма.СтруктураДанныхРаздел4.П000400000214;
			Форма.СтруктураДанныхРаздел1.П000100012303 = Форма.СтруктураДанныхРаздел4.П000400000207;
			Форма.СтруктураДанныхРаздел1.П000100012304 = Форма.СтруктураДанныхРаздел4.П000400000209;
...
Функция НомераПервыхСтраницРаздела25иРаздела6()
	...
	Для Каждого ЭлементСписка Из СтруктураРеквизитовФормы.мПечатныеФормы Цикл
		Если Найти(СтрокаПоиска, ЭлементСписка.Представление) > 0 Тогда
...
Процедура ПроставитьПредставленияИНомераЛистов(ЭтаФорма, ПризнакНумеруемыхФорм = Истина,
	...
	Если ПризнакНумеруемыхФорм Тогда
		...
		Если ЭтаФорма.СтруктураРеквизитовФормы.мСчетчикСтраниц <> Истина Тогда
			...
			Для Ном = 0 По ЭтаФорма.СтруктураРеквизитовФормы.мПечатныеФормы.Количество() - 1 Цикл
				...
				Если Найти(Эл.Представление, "Раздел 2.5") > 0 Тогда
				...
				ИначеЕсли Найти(Эл.Представление, "Раздел 6") > 0 Тогда
	...
	Для Каждого Эл Из ЭтаФорма.СтруктураРеквизитовФормы.мПечатныеФормы Цикл
		...
		Если Найти(Эл.Представление, "Раздел 6") > 0 Тогда
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	Если ИдГруппы <> Неопределено Тогда
		...
		КолвоСтрокВПечатнойФорме = Число(
			Сред(ИмяОбластиПоследнейДопСтроки, Найти(ИмяОбластиПоследнейДопСтроки, "_") + 1));
			...
			Для Ном = 0 По КолвоДопСтрок Цикл
				...
				Для Каждого Область Из МакетПечатнойФормы.ПолучитьОбласть(
					...
					Если НЕ НайденнаяОбласть = Неопределено Тогда 
						НайденнаяОбласть.Имя = Лев(Область.Имя, Найти(Область.Имя, "_") - 1) + "_"
...
Функция ЗаполненЛистРаздела24(ДанныеЛиста)
	...
	Для Каждого Показатель Из ДанныеЛиста Цикл
		Если Найти(Показатель.Ключ, "П00024") = 1 Тогда
...
Процедура ОтсечьНезаполненныеНеобязательныеУзлы(Узел)
	...
	Если ТипЗнч(Узел) <> Тип("ДеревоЗначений") Тогда
		...
		И УзелПуст(Узел)
		И ?(Найти(Узел.Обязательность, "О") <> 0 ИЛИ Найти(Узел.Обязательность, "O") <> 0,
...
Процедура ПроверитьЗаполнениеТитульный(ПараметрыВыгрузки, ДеревоВыгрузки, СтатусПроверки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ЛицоПодтверждающееСведения) Тогда
		...
		СтатусПроверки = Ложь;
	ИначеЕсли Найти("1,2,3", ПараметрыВыгрузки.ЛицоПодтверждающееСведения) = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(
...
Процедура ЗаписатьЗамер(ВремяНачала)
	...
	// СтандартныеПодсистемы.ОценкаПроизводительности
	Если ВремяНачала
	  <> Неопределено И ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует(
...
Процедура ПроверкаТитульногоЛиста(СтруктураРезультата)
	...
	Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ЗначениеПоказателя1) И 
		СтрДлина(ЗначениеПоказателя1) = 1 И Найти("123", ЗначениеПоказателя1) > 0) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
	Иначе
		ЭтоОшибка = Истина;
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		Для ИндК = 1 По 8 Цикл // с П000500000110_1 по П000500000180_1 
			...
			Если ЗначениеЗаполнено(Раздел5[ИмяПоказателяЛевойЧасти]) Тогда 
				...
				//	"Строка " + НомСтрСтр + " графа " + НомКолСтр + " раздел 5", Раздел5[ИмяПоказателяЛевойЧасти], "", 
				//	СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, НомерСтраницыСтр, СчетчикФормулДляРасшифровок);
				Прервать;
			КонецЕсли;
		КонецЦикла;
