...
&НаКлиенте
Процедура ОткрытьПервФормуОтчета(Команда)
...
Процедура ОткрытьФормуОтчета(ВидДокумента)
	...
	Если СтандартнаяОбработка Тогда
		...
		ОткрытьФорму(СтрЗаменить(
			ЭтаФорма.ИмяФормы, "ОсновнаяФормаДополнительная", "") + мВыбраннаяФорма, ПараметрыФормы);
...
Процедура ПоказатьПериод(Форма)
	...
	Если КоличествоФорм >= 1 Тогда
		...
		Форма.Элементы.ОткрытьПервФормуОтчета.Доступность = Истина;
	...
	Иначе
		...
		Форма.Элементы.ОткрытьПервФормуОтчета.Доступность = Ложь;
...
Процедура УправлениеВидимостьюЭлементов(Форма, ДатаКонцаПериодаОтчета)
	...
	Если ДатаКонцаПериодаОтчета >= '20140101' Тогда
		...
		Форма.Элементы.ОткрытьПервФормуОтчета.Видимость  = Истина;
	...
	Иначе
		...
		Форма.Элементы.ОткрытьПервФормуОтчета.Видимость  = Ложь;
