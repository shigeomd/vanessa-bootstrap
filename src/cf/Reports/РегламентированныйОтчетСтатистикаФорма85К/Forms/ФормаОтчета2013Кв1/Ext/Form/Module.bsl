...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Не (Область.Защита = Истина) И Область.СодержитЗначение = Истина Тогда 
		...
		ИначеЕсли (Не СтруктураРеквизитовФормы.мАвтоВыборКодов) И (Найти(Область.Имя, "П000002060201_") = 1
			Или Найти(Область.Имя, "П000002060203_")) Тогда
...
Функция ПолеДаНет(ИмяОбласти)
	Если (Найти(ИмяОбласти, "П0101") = 1 
			Или Найти(ИмяОбласти, "П0102") = 1
			Или Найти(ИмяОбласти, "П0402") = 1
