...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли (Не (Область.Защита = Истина)) И Найти(Область.Имя, "_") = 14 Тогда 
		...
		Если Найти(Область.Имя, "П000002000102_") = 1 Или Найти(Область.Имя, "П000002000103_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000004000103_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000004000104_") = 1 Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Найти(Область.Имя, "П000004000104_") = 1 Тогда
