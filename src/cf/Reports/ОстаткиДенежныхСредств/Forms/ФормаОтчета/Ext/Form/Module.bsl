...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Предупреждения = ОбщегоНазначенияБП.НастройкиПредупрежденийОбИзменениях(КлючиНастроек);
...
Процедура ПриОткрытии(Отказ)
	...
	Если Предупреждения.ОтправкаПоЭлектроннойПочте Тогда
...
Процедура Подключаемый_ПоказатьИнформациюОтправкаПоЭлектроннойПочте()
	...
	ОбщегоНазначенияБПКлиент.ПоказатьПредупреждениеОбИзменениях("ОтправкаПоЭлектроннойПочте", , Предупреждения);
