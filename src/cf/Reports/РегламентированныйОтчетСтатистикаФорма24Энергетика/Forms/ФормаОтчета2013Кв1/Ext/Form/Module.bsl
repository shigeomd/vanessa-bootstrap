...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Найти(Область.Имя, "П000002000102") > 0 Тогда
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	ИначеЕсли (Найти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0) И (Сред(Область.Имя, 12, 2) = "01") Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если (Найти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0) И (Сред(Область.Имя, 12, 2) = "01") И (ОбластьЗначения <> Неопределено) Тогда
		
		ВыборНазвание = СокрП(РезультатВыбора["Название"]);
		ОбластьЗначения.Значение = ВыборНазвание;
		
	ИначеЕсли (Найти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0) И (Сред(Область.Имя, 12, 2) = "04") Тогда
...
Функция СформироватьСтруктуруПараметров()
	...
	Для Каждого КлючИЗначение Из ТабДокумент Цикл
		Если Найти(КлючИЗначение.Ключ, "П00000100") = 1 Тогда
