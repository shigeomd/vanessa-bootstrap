...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение3" Тогда
		...
		Если Найти(Область.Имя, "П000260001005") > 0 Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли Найти(Область.Имя, "КППРаздел23") > 0 Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение1" Тогда
		...
		Если Найти(ОбластьИмя, "П000240010002") > 0 
		   Или Найти(ОбластьИмя, "П000240010005") > 0 Тогда
			#Если ВебКлиент Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение2" Тогда
		...
		Если Найти(ОбластьИмя, "П000250010002") > 0 
		   Или Найти(ОбластьИмя, "П000250010005") > 0 Тогда
			#Если ВебКлиент Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение3" Тогда
		...
		Если (Найти(ОбластьИмя, "П000260001002") > 0 ) Или (Найти(ОбластьИмя, "П000260001003") > 0) Или (Найти(ОбластьИмя, "П000260001004") > 0) Тогда
