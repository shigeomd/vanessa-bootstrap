...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь, СменилсяПризнакПодписанта = Ложь)
	...
	Если (СтруктураРеквизитовФормы.мВПрограммеИзмененаОрганизация) ИЛИ (НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области.ОКВЭД.Значение)) Тогда
...
Процедура ВывестиРазделВТабличныйДокумент(Форма, ИмяГруппы, СтруктураГруппы, ИмяТекРаздела)
	...
	//Форма.мСтруктураМногострочныхРазделов[ИмяГруппы] = СтруктураГруппы.Скопировать();
...
Процедура ДобавитьСтроку(Команда)
	...
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку1м"
		  ...
		  ИЛИ (Найти(ТекущаяОбласть.Имя, "П0000100163") > 0 ИЛИ Найти(ТекущаяОбласть.Имя, "П0000700121") > 0) Тогда
	...
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку2м"
		 ...
		 ИЛИ (Найти(ТекущаяОбласть.Имя, "П0000100164") > 0 ИЛИ Найти(ТекущаяОбласть.Имя, "П0000700122") > 0) Тогда
		Если ТекРаздел = "Раздел1_1" Тогда
	...
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку3м"
		 ...
		 ИЛИ (Найти(ТекущаяОбласть.Имя, "П0000100165") > 0 ИЛИ Найти(ТекущаяОбласть.Имя, "П0000700123") > 0) Тогда
		Если ТекРаздел = "Раздел1_1" Тогда
...
Процедура ДобавитьНеобходимоеКоличествоДопСтрокНаСервере(ТекТабличноеПоле, ТекТабличноеПолеИмя, ИсходноеКоличествоСтрокГруппы, ТекущееКоличествоСтрокГруппы, ИмяГруппы, СтруктураГруппы) Экспорт
	...
	//ОбластьМСЧ = ТекТабличноеПоле.Область(ВерхОбластиМногострочнойЧасти, , НизОбластиМногострочнойЧасти + ПомежуточныйТабличныйДокумент.ВысотаТаблицы, );
...
Процедура СпециальногоДобавленияСтроки(ТекТабличноеПоле, ТекТабличноеПолеИмя, ИмяГруппы, НомерВерхЯчейкиОбласти, НомерНижнЯчейкиОбласти, СтруктураГруппы, НомерПоследнейСтроки, ВерхОбластиМногострочнойЧасти, ВысотаСтроки, ИмяОбластиМСЧ) Экспорт
	...
	//ОбластьМСЧ = ТекТабличноеПоле.Область(ВерхОбластиМногострочнойЧасти, , НомерНижнЯчейкиОбласти + ВысотаСтроки, );
