...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		Сведения = "ИННЮЛ, КППЮЛ, НаимЮЛПол, КодНО, НаимНО, ТипНП, ТелОрганизации, ОКВЭДКвадратикиТочкиРазделения, ";
	КонецЕсли;
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Титульный" Тогда 
		...
		Если ((Найти(Область.Имя, "КодИМНС") > 0) Или (Найти(Область.Имя, "ОргИМНС") > 0)) И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			СтандартнаяОбработка = Ложь;
			Модифицированность = Истина;
			ОбработкаВыбораИФНС();
		КонецЕсли;
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		Если (Найти(ОбластьИмя, "КБКРаздел1") > 0 ИЛИ Найти(ОбластьИмя, "КБК2Раздел1") > 0) И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			СтандартнаяОбработка = Ложь;
			...
			ИначеЕсли Найти(ОбластьИмя, "КБК2Раздел1") > 0 Тогда
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Лист02_Прил1" Тогда	
		...
		Если (Найти(ОбластьИмя, "П002010001001_") > 0 ИЛИ Найти(ОбластьИмя, "П002010001002_") > 0) И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			СтандартнаяОбработка = Ложь;
			
			Если Найти(Область.Имя, "П002010001001_") > 0 Тогда 						
			...
			ИначеЕсли Найти(ОбластьИмя, "П002010001002_") > 0 Тогда
		...
		ИначеЕсли Призн = "*" Тогда //раздел многостраничный
			...
			Для Каждого Стр2 из ТаблицаСтраницРаздела Цикл
				...
				Для Каждого Стр3 Из СтрокиФорматаТекРаздела Цикл
					...
					КонецЕсли;
					ЗначениеЯчейки = ТекПок[ИмяЯчейки];
					//ЗначениеЯчейки = ТекПок[ИмяЯчейкиИзмДляСоотв];
