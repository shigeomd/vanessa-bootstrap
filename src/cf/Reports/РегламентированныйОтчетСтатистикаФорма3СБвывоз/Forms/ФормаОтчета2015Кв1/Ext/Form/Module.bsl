...
Процедура ОчиститьТабличноеПоле(Форма, ВыбТабличноеПолеИмя) Экспорт
	...
	Для Каждого ТекущаяОбласть Из ВыбТабличноеПоле.Области Цикл
		...
		Если Сред(ТекОблИмя, 1, 13) = "П000001000103" Или Найти(СтрокаПоиска2, ТекОблИмя) > 0 Тогда
			ТекущаяОбласть.Значение = 0;
		ИначеЕсли Сред(ТекОблИмя, 1, 13) = "П000001000101" Или Сред(ТекОблИмя, 1, 13) = "П000001000102" Или Найти(СтрокаПоиска1, ТекОблИмя) > 0 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "РазделВывозимыеТовары" Тогда
		...
		Если Найти(Область.Имя, "КодИсточника") > 0 Тогда
		...
		ИначеЕсли Область.Имя = "НаименованиеТовара" Тогда
			...
			КонецЕсли;
		ИначеЕсли Найти(Область.Имя, "П000001000101") > 0 Или Найти(Область.Имя, "П000001000102") > 0 Тогда
