...
Процедура ПроверитьЗаполнениеДекларация(ПараметрыВыгрузки, СтатусПроверки)
	...
	Для Каждого ЛистРаздела Из ДанныеРаздела Цикл
		...
		КонецЕсли;
		ПроверитьЗаполнениеТаблицыДекларация(СтатусПроверки, СтруктураРеквизитовФормы.мИдГруппы12, ДанныеДопСтрок, ДопДанные, НомерЛиста);
...
&НаСервере
Процедура ПроверитьЗаполнениеТаблицыДекларация(СтатусПроверки, ИдГруппы, ДанныеДопСтрок, ДополнительныеДанные, НомерЛиста)
...
Процедура ПроверитьЗаполнениеВозвраты(ПараметрыВыгрузки, СтатусПроверки)
	...
	Для Каждого ЛистРаздела Из ДанныеРаздела Цикл
		...
		КонецЕсли;
		ПроверитьЗаполнениеТаблицыВозвраты(СтатусПроверки, СтруктураРеквизитовФормы.мИдГруппы22, ДанныеДопСтрок, ДопДанные, НомерЛиста);
...
&НаСервере
Процедура ПроверитьЗаполнениеТаблицыВозвраты(СтатусПроверки, ИдГруппы, ДанныеДопСтрок, ДополнительныеДанные, НомерЛиста)
