...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_314_329, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_330_336, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_401_438, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_439_445, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_446_447, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101011003.Значение = 1;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_448_459, ОбластьИмя) > 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_614_621, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010203.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
