...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_301_306, ОбластьИмя) > 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_307_313, ОбластьИмя) > 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строка_312, ОбластьИмя) > 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_314_328, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_329_340, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_401_431, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строка_431, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Ложь;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_432_433, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010103.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010303.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010803.Значение = 1
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_434_435, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Форма.ТабличныйДокумент.Области.П101010703.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101010803.Значение = 1
			ИЛИ Форма.ТабличныйДокумент.Области.П101011003.Значение = 1;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строки_436_443_446_449, ОбластьИмя) > 0 Тогда
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ Найти(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Строка_901_905, ОбластьИмя) > 0 Тогда
			УсловиеДоступа = Ложь;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ОргНазв) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задано наименование оганизации!", "Титульный", "ОргНазв");
		СтатусПроверки = Ложь;
	КонецЕсли;
