...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СоставПоказателей2014Кв1");
...
Процедура ЗаполнитьСведенияОбОрганизацииНаСервере()
	...
	СтрокаСведений = "НаимЮЛПол, ФИО, РегистрационныйНомерФСС, ОКВЭД, АдрЮР, АдрФакт, АдрПрописки";
	...
	НаименованиеСРеквизитами = НаименованиеОрганизации + Символы.ПС
	                         ...
	                         + "; Код ОКВЭД: " + СокрЛП(СведенияОбОрганизации.ОКВЭД);
