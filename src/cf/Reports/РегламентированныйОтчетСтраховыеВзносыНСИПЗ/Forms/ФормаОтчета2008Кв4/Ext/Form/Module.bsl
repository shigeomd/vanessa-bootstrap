...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    ПолеТабличногоДокументаФормаОтчета.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ИмяРаздела));
...
Процедура УстановитьФорматВывода(Форма)
	...
	Для Инд = 0 По мФормаОтчета.Области.Количество() - 1 Цикл
		...
		Если Найти(ИмяПоказателя, "П000010001004") > 0 Или Найти(ИмяПоказателя, "П000010001005") > 0 
		Или  Найти(ИмяПоказателя, "П000010001010") > 0 Или Найти(ИмяПоказателя, "П000010001011") > 0 
		Или  Найти(ИмяПоказателя, "П000010001018") > 0 Или Найти(ИмяПоказателя, "П000010001019") > 0 
		Или  Найти(ИмяПоказателя, "П000010001021") > 0 Или Найти(ИмяПоказателя, "П000010001022") > 0 
		Или  Найти(ИмяПоказателя, "П000010001024") > 0 Или Найти(ИмяПоказателя, "П000010001025") > 0 Тогда
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ЗначениеЗаполнено(мФормаОтчета.Области.ОКВЭД.Значение) Тогда
		мФормаОтчета.Области.ОКВЭД.Значение=СокрЛП(ОКВЭД);
	КонецЕсли;
		...
		Для Каждого Область Из ОбластьДопСтроки.Области Цикл
			...
			Если ОбластьТаблДок.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник Тогда
				...
				Если НомНовойСтроки < ТекущееКоличествоСтрокГруппы Тогда
					...
					Если Найти(ОбластьТаблДок.Имя, "П000010001001") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001002") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001003") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001004") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001005") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001010") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001011") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001017") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001018") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001019") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001021") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001022") > 0 
						ИЛИ  Найти(ОбластьТаблДок.Имя, "П000010001024") > 0 Или Найти(ОбластьТаблДок.Имя, "П000010001025") > 0 Тогда
...
Процедура ВставитьДополнительнуюСтрокуНаСервере()
	...
	Для Каждого Колонка Из ДанныеФормыВЗначение(СтруктураГруппы, Тип("ТаблицаЗначений")).Колонки Цикл
		...
		Если Найти(ИмяКолонки, "П000010001001") > 0 Или Найти(ИмяКолонки, "П000010001002") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001003") > 0 Или Найти(ИмяКолонки, "П000010001004") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001005") > 0 Или Найти(ИмяКолонки, "П000010001010") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001011") > 0 Или Найти(ИмяКолонки, "П000010001017") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001018") > 0 Или Найти(ИмяКолонки, "П000010001019") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001021") > 0 Или Найти(ИмяКолонки, "П000010001022") > 0 
		ИЛИ  Найти(ИмяКолонки, "П000010001024") > 0 Или Найти(ИмяКолонки, "П000010001025") > 0 Тогда
