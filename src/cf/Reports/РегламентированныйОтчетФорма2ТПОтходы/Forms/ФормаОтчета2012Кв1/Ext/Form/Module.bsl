...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрЧислоВхождений(Область.Имя, "УдалитьСтроку") > 0 Тогда
		УдалитьСтроку("");
	ИначеЕсли (Не (Область.Защита = Истина)) И Найти(Область.Имя, "_") = 14 И СтруктураРеквизитовФормы.мАвтоВыборКодов = Ложь Тогда 
		Если Найти(Область.Имя, "П000004000102") = 1 Или Найти(Область.Имя, "П000004000103") = 1 Тогда 
		...
		ИначеЕсли Найти(Область.Имя, "П000002000102") = 1 Или Найти(Область.Имя, "П000002000103") = 1 Тогда 
		...
		ИначеЕсли Найти(Область.Имя, "П000004000104") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000002000104") = 1 Тогда 
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "КлассОпасностиОтходов");
			ВвестиПоказатель(Область, ПараметрВводаПоля.Показатель, ПараметрВводаПоля.ТекстПриВыборе,
							ПараметрВводаПоля.ТаблицаЗначений, СтандартнаяОбработка);
		КонецЕсли;
...
Процедура ПолеТабличногоДокументаФормаОтчетаПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если Найти(Область.Имя, "П000004000102") = 1 Или Найти(Область.Имя, "П000004000103") = 1 Или Найти(Область.Имя, "П000004000104") = 1 Тогда 
		ПолеТабличногоДокументаФормаОтчета.Области[СтрЗаменить(Область.Имя, "П000004", "П000002")]. Значение = Область.Значение;
	ИначеЕсли Найти(Область.Имя, "П000002000102") = 1 Или Найти(Область.Имя, "П000002000103") = 1 Или Найти(Область.Имя, "П000002000104") = 1 Тогда 
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Вещества", 512, , "Выбор кода загрязняющего вещества", КоллекцияСписковВыбора["Вещества"]);
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Найти(Область.Имя, "П000004") = 1 Тогда 
