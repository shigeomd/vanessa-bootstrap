		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020018003, ОбластьИмя) > 0 Тогда
				...
				Если КодВидаИмущества = "1"
					...
					Делимое = СтоимостьОблагаемогоНалогомИмущества
					* (ПолеТабличногоДокументаРаздел2.П000020017003.Значение / 100);
				...
				ИначеЕсли КодВидаИмущества = "2" Тогда
					Коэффициент150 = ?(ПолеТабличногоДокументаРаздел2.П000020015003_Знам.Значение = 0, 0, ПолеТабличногоДокументаРаздел2.П000020015003_Числ.Значение / ПолеТабличногоДокументаРаздел2.П000020015003_Знам.Значение);
					Делимое = СтоимостьОблагаемогоНалогомИмущества
					* (ПолеТабличногоДокументаРаздел2.П000020017003.Значение / 100)
					* Коэффициент150;
					ПолеТабличногоДокументаРаздел2.П000020018003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое / 4);
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРазделаРаздел2 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020018003, ОбластьИмя) > 0 Тогда
			...
			Если КодВидаИмущества = "1"
				...
				ИЛИ КодВидаИмущества = "5" Тогда
				Делимое = СтоимостьОблагаемогоНалогомИмущества
				* (ПолеТабличногоДокументаРаздел2.П000020017003 / 100);
			...
			ИначеЕсли КодВидаИмущества = "2" Тогда
				Коэффициент150 = ?(ПолеТабличногоДокументаРаздел2.П000020015003_Знам = 0, 0, ПолеТабличногоДокументаРаздел2.П000020015003_Числ / ПолеТабличногоДокументаРаздел2.П000020015003_Знам);
				Делимое = СтоимостьОблагаемогоНалогомИмущества
				* (ПолеТабличногоДокументаРаздел2.П000020017003 / 100)
				* Коэффициент150;
				ПолеТабличногоДокументаРаздел2.П000020018003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое / 4);
...
Процедура СформироватьРаздел1()
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		Если НЕ ПустаяСтрока(ОКАТО) И НЕ ПустаяСтрока(ВидИмущества) И Найти("1235", ВидИмущества) <> Неопределено Тогда
