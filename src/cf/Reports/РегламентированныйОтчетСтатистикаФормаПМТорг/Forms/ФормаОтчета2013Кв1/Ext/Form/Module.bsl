	...
	Если (МесяцСохраненногоОтчета = МесяцДействияРаздела) И (МесяцТекущегоОтчета <> МесяцДействияРаздела) Тогда
		...
		Для Каждого СтруктураПоказателейРаздела Из ПоказателиОтчета Цикл
			...
			Для Каждого Показатель Из СтруктураПоказателейРаздела.Значение Цикл
				...
				Если Найти(Показатель.Ключ, Лев(СтруктураРеквизитовФормы.мИдГруппы1, 8)) > 0 Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	// раздел 2 
	// колонки 2
	Если Найти(Область.Имя, "П003000200102") > 0 Тогда
	...
	// колонки 3
	ИначеЕсли Найти(Область.Имя, "П003000200103") > 0 Тогда
