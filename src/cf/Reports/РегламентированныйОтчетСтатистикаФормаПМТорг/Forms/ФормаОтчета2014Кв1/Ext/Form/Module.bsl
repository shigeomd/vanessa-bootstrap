...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если СтруктураРеквизитовФормы.мСкопированаФорма <> Неопределено Тогда
		...
		Если Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) <> 1 Тогда
			...
			//ЭтаФорма.мСтруктураКолвоКолонокРазделов.Свойство(СтруктураРеквизитовФормы.мИдГруппы1, ИсхКолГраф);
			
			Пока ЭтаФорма.П0000020001.Количество() > ИсхКолСтрок Цикл
				//Для НомГрафы = 0 По ИсхКолГраф Цикл
				//	ПолеТабличногоДокументаФормаОтчета.УдалитьОбласть(ПолеТабличногоДокументаФормаОтчета.Область(СтруктураРеквизитовФормы.мИдГруппы1 + Формат(НомГрафы, "ЧЦ=2; ЧВН=; ЧГ=") + "_" + Формат(ЭтаФорма.П0000020001.Количество(), "ЧГ=")));
				//КонецЦикла;
