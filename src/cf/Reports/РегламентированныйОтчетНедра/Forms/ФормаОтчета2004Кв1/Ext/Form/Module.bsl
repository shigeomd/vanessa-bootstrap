...
Процедура ОчиститьНаСервере() Экспорт
	...
	Если НЕ (СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Титульный" Или СтруктураРеквизитовФормы.НаимТекущегоРаздела = "ФизЛица")  Тогда
...
Функция ВычислитьПоказателиТитульногоЛистаИСведенияОФизЛицах(БратьИзФормы = Истина, ВыводитьСообщения = Истина)
	...
	ТитульныйВидДок = ?(Число(ПоказателиТитульный.НомКоррект) > 0, "3", "1");
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли ТекущийРаздел =  "Титульный" Тогда
		...
		Если (Найти(ИмяЯчейки, "КодИМНС") > 0) Или (Найти(ИмяЯчейки, "ОргИМНС") > 0) Тогда
