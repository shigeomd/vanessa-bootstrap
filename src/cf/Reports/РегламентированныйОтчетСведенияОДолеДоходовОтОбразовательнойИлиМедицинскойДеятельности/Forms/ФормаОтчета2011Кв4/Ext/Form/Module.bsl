...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "") Экспорт
	...
	Для НомерСтроки = 20 По 32 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета[ИмяСтроки + "05"], ОбластьИмя) > 0 Тогда
...
Функция СформироватьСтруктуруПараметров()
	...
	//ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "ДохОбрМед");
