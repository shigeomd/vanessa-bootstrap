...
Функция ПериодичностьИзСтроки(СтрПериодичность)
	...
	Если Найти(СтрокаПериодичность, "1 раз") > 0 ИЛИ Найти(СтрокаПериодичность, "годовая") > 0 Тогда
		Периодичность = Периодичность + 1;
	КонецЕсли;
	Если Найти(СтрокаПериодичность, "2 раза") > 0 ИЛИ Найти(СтрокаПериодичность, "полугод") > 0 Тогда
		 Периодичность = Периодичность + 2;
	КонецЕсли;
	Если Найти(СтрокаПериодичность, "квартальная") > 0 Тогда
		 Периодичность = Периодичность + 4;
	КонецЕсли;
	Если Найти(СтрокаПериодичность, "месячная") > 0 Тогда
		 Периодичность = Периодичность + 12;
	КонецЕсли;
	Если Найти(СтрокаПериодичность, "декадная") > 0 Тогда
		 Периодичность = Периодичность + 36;
	КонецЕсли;
	Если Найти(СтрокаПериодичность, "недельная") > 0 Тогда
