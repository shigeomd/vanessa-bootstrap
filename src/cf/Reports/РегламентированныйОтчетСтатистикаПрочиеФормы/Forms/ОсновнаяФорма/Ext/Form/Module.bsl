...
Процедура ОткрытьФормуОтчета(Команда)
	...
	СтрВыбраннаяФорма = ?(Найти(мВыбраннаяФорма, "_") = 0, мВыбраннаяФорма, Лев(мВыбраннаяФорма, Найти(мВыбраннаяФорма, "_") - 1));
	ВыбФормаОтчета = ПолучитьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "ОсновнаяФорма", "") + СтрВыбраннаяФорма, ПараметрыФормы);
...
Процедура ВыбратьФорму(Команда)
	...
	ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "ОсновнаяФорма", "ВыборФормыОтчета"), ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
