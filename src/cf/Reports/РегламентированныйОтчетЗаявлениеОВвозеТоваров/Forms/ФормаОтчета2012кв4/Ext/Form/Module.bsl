...
Процедура ВывестиНаПечатьЛистРаздел1(СтруктураПараметров)
	...
	МакетПечатиРаздела = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("ПечатнаяФормаОтчета2012Кв3_Раздел1");
	
	МакетОбразцаПечатиРаздела = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("ПечатнаяФормаОтчета2012Кв3_Раздел1");
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СтруктураXML506");
