...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СтруктураXML504");
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000010000107") > 0 Тогда
			...
			ДополнительныеПараметры = Новый Структура("Область, СтандартнаяОбработка, ФормаВыбора, Элемент, ПолеТабличногоДокументаРаздел1", Область, СтандартнаяОбработка, ФормаВыбора, Элемент, ПолеТабличногоДокументаРаздел1);
