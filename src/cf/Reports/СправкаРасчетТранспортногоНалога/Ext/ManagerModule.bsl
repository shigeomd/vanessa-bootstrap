...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт
	...
	Возврат "Справка-расчет транспортного налога" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(
...
Функция ВариантыНастроек() Экспорт
	...
	Массив.Добавить(Новый Структура("Имя, Представление", "РасчетТранспортногоНалога", "Расчет транспортного налога"));
