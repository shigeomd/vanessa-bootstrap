...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если Найти(КодПоказателя, "П0000050086") > 0 Тогда
	...
	ИначеЕсли Найти(КодПоказателя, "П0000050087") > 0 Тогда
		ИмяПоказателяКод1 = Лев(Область.Имя, 11) + "04" + Сред(Область.Имя, 14);
		ИмяПоказателяКод2 = Лев(Область.Имя, 11) + "05" + Сред(Область.Имя, 14);
		ИсходноеЗначение = ?(ЗначениеЗаполнено(ТабличныйДокумент.Области[ИмяПоказателяКод1].Значение),
			ТабличныйДокумент.Области[ИмяПоказателяКод1].Значение, ТабличныйДокумент.Области[ИмяПоказателяКод2].Значение);
	ИначеЕсли Найти(КодПоказателя, "П0000050088") > 0 Тогда
		ИмяПоказателяКод1 = Лев(Область.Имя, 11) + "04" + Сред(Область.Имя, 14);
		ИмяПоказателяКод2 = Лев(Область.Имя, 11) + "05" + Сред(Область.Имя, 14);
		ИсходноеЗначение = ?(ЗначениеЗаполнено(ТабличныйДокумент.Области[ИмяПоказателяКод1].Значение),
			ТабличныйДокумент.Области[ИмяПоказателяКод1].Значение, ТабличныйДокумент.Области[ИмяПоказателяКод2].Значение);
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Найти(КодПоказателя, "П0000050087") > 0 ИЛИ Найти(КодПоказателя, "П0000050088") > 0 Тогда
		ИмяПоказателяКод1 = Лев(Область.Имя, 11) + "04" + Сред(Область.Имя, 14);
		ИмяПоказателяКод2 = Лев(Область.Имя, 11) + "05" + Сред(Область.Имя, 14);
		ИмяПоказателяНазвание = Лев(Область.Имя, 11) + "01" + Сред(Область.Имя, 14);
		Если СтрДлина(СокрЛП(РезультатКод)) > 4 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел3_5" Тогда
		...
		Если Найти(Область.Имя, "П000005008601_") > 0 ИЛИ Найти(Область.Имя, "П000005008604_") > 0 ИЛИ Найти(Область.Имя, "П000005008605_") > 0 Тогда
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел5" Тогда
		...
		Если Найти(Область.Имя, "П000005008701_") > 0 ИЛИ Найти(Область.Имя, "П000005008704_") > 0 ИЛИ Найти(Область.Имя, "П000005008705_") > 0
		 ИЛИ Найти(Область.Имя, "П000005008801_") > 0 ИЛИ Найти(Область.Имя, "П000005008804_") > 0 ИЛИ Найти(Область.Имя, "П000005008805_") > 0 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "Коды_ОКАТО_ОКСМ");
			//создание динамического списка выбора
			Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено Тогда
				КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
