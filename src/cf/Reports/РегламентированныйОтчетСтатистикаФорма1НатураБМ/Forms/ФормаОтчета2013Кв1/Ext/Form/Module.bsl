...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрЧислоВхождений(Область.Имя, "УдалитьСтроку") > 0 Тогда
		УдалитьСтроку("");
	ИначеЕсли (Не (Область.Защита = Истина)) И Найти(Область.Имя, "_") = 14 Тогда 
		НомерСтроки = Сред(Область.Имя, 15);
		ОбластиДляОбнуления = Новый Массив;
		
		Если Найти(Область.Имя, "П000001000101_") = 1 Или Найти(Область.Имя, "П000001000103_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000001000102_") = 1 Или Найти(Область.Имя, "П000001000104_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000002000101_") = 1 Или Найти(Область.Имя, "П000002000103_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000002000102_") = 1 Или Найти(Область.Имя, "П000002000104_") = 1 Тогда
			...
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП54_55");
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ЕИОКПОтфильтрованный");
		ИначеЕсли Найти(Область.Имя, "П000004000101_") = 1 Или Найти(Область.Имя, "П000004000103_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000004000102_") = 1 Или Найти(Область.Имя, "П000004000104_") = 1 Тогда
			...
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ЕИОКПОтфильтрованный");
		ИначеЕсли Найти(Область.Имя, "П000005000101_") = 1 Или Найти(Область.Имя, "П000005000103_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ОКПД_56");
		...
		ИначеЕсли Найти(Область.Имя, "П000005000102_") = 1 Или Найти(Область.Имя, "П000005000104_") = 1 Тогда
			...
			ОтфильтроватьЕдиницыИзмеренияПоКодуОКПД(ОтборЗначение, "ЕИОКП56");
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ЕИОКПОтфильтрованный");
		ИначеЕсли Найти(Область.Имя, "П000003000101_") = 1 Или Найти(Область.Имя, "П000003000102_") = 1 Тогда
	...
	Если Найти(Область.Имя, "_") = 14 Тогда
		Если Найти(Область.Имя, "П0000040001") = 1 Тогда
			СинхронизироватьРаздел4("П0000040001", "П0000050001", Сред(Область.Имя, 15));
		ИначеЕсли Найти(Область.Имя, "П0000050001") = 1 Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Найти(ОбластьСобытия.Имя, "_") = 14 Тогда
		Если Найти(ОбластьСобытия.Имя, "П0000040001") = 1 Тогда
			СинхронизироватьРаздел4("П0000040001", "П0000050001", Сред(ОбластьСобытия.Имя, 15));
		ИначеЕсли Найти(ОбластьСобытия.Имя, "П0000050001") = 1 Тогда
