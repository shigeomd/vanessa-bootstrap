...
Процедура ЗаполнитьСведенияОбОрганизации(ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	ПБОЮЛ = СтруктураРеквизитовФормы.ИП;
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ БезОткрытияФормы Тогда
		СтруктураРеквизитовФормы.мПустойОбразЛистаФЛ = СформироватьПустройФизЛицЛист();//СобратьДанныеТекущегоТаблПоля(ЭтаФорма, "ПолеТабличногоДокументаФизЛица");
