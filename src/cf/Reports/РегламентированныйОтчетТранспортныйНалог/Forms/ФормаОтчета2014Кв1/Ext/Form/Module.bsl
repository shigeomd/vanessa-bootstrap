...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если (Найти(ОбластьИмя, "КодИМНС") > 0) Тогда
	...
	ЭтоПолеВводаОснованияЛьготы = (Найти(ОбластьИмя, "_Основание") > 0);
...
Процедура ИзменитьФорматНевведенныхПоказателей(Форма)
	...
	ИначеЕсли Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		Для Каждого Область Из Форма.ТабличныйДокумент.Области Цикл
			Если Найти(Область.Имя, "П00002") = 1
...
Функция СформироватьСтруктуруПараметров()
	...
	ФИОПодписанта = РегламентированнаяОтчетностьКлиентСервер.РазложитьФИО(Титульный.Подписант);
