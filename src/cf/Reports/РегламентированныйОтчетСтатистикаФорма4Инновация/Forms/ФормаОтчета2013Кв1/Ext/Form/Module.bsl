...
Процедура ЗаполнитьМассив()
	...
	Для каждого Эл Из мТаблицаСоставПоказателей Цикл
		...
		Если Найти(Показатель, "П002") > 0 Тогда
			СтруктураРеквизитовФормы.Массив1.Добавить(Показатель);	
		ИначеЕсли Найти(Показатель, "П003") > 0 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Иначе
		Если (Найти(Область.Имя, "П1111")= 1 И СтрДлина(Область.Имя) = 7)
			Или (Найти(Область.Имя, "П1212")= 1  И СтрДлина(Область.Имя) = 7)
			Или (Найти(Область.Имя, "П0202")= 1 И СтрДлина(Область.Имя) = 7)
		...
		ИначеЕсли Найти(Область.Имя, "П0404")= 1 И Число(Прав(Область.Имя, 2)) <= 13 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "Факторы");
		ИначеЕсли Найти(Область.Имя, "П0808")= 1
			Или (Найти(Область.Имя, "П0909")= 1 И СтрДлина(Область.Имя) = 7 И Область.Имя <> "П090912") Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "Значительность");
		ИначеЕсли Найти(Область.Имя, "П0606")= 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "Воздействие");
		ИначеЕсли Найти(Область.Имя, "П020209") = 1 
			Или Найти(Область.Имя, "П020210") = 1 
			Или Найти(Область.Имя, "П020211") = 1 Тогда 
