...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Список2014Кв1");
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Найти(Область.Имя, "П000060000303_") = 1 Тогда
	...
	ИначеЕсли Найти(Область.Имя, "П000040000104_") = 1 Тогда
	...
	ИначеЕсли Найти(Область.Имя, "П000040000103_") = 1 Тогда
		ОбластьНазвание = СтрЗаменить(Область.Имя, "П000040000103_", "П000040000102_");
		ТабличныйДокумент.Области[ОбластьНазвание].Значение = РезультатНазвание;
	ИначеЕсли Найти(Область.Имя, "П000050009003_") = 1 Тогда
		ОбластьНазвание = СтрЗаменить(Область.Имя, "П000050009003_", "П000050009001_");
		ТабличныйДокумент.Области[ОбластьНазвание].Значение = РезультатНазвание;
	ИначеЕсли Найти(Область.Имя, "П000010001002_") = 1 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "МПм" Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000040000104_") Или Найти(Область.Имя, "П000040000101_") Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000040000103_") Или Найти(Область.Имя, "П000040000102_") Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П00001000") = 1 И Прав(Область.Имя, 3) = "003"
		...
		Иначе 
			...
			Если Найти(Область.Имя, "П000010000100") > 0 Тогда
				
				СтандартнаяОбработка = Ложь;
				
				Если  Найти("П0000100001001.П0000100001002", Область.Имя) > 0 Тогда
					Для Идн = 1 По 2 Цикл
						...
						КонецЕсли;
					КонецЦикла;
				ИначеЕсли  Найти("П0000100001003.П0000100001004", Область.Имя) > 0 Тогда
					Для Идн = 3 По 4 Цикл
						Если ("П000010000100"+Идн) = Область.Имя Тогда
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение1" Тогда 
		Если Найти(Область.Имя, "П000010001001_") = 1
			Или Найти(Область.Имя, "П000010001002_") = 1 Тогда
			ОбластьИмя = Область.Имя;
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение2" Тогда 
		...
		Если Найти("П0000100001001,П0000100001002,П0000100001003,П0000100001004", Область.Имя) > 0 Тогда
			СтандартнаяОбработка = Ложь;
		...
		ИначеЕсли Область.Имя = "П0000100001006" Тогда
			...
			Модифицированность = Истина;
		ИначеЕсли Найти(Область.Имя, "П000050009001_") = 1
			Или Найти(Область.Имя, "П000050009003_") = 1 Тогда
			ОбластьИмя = Область.Имя;
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение3" Тогда
		...
		Если Найти(Область.Имя, "П00006000030") = 1
			И Найти(Область.Имя, "П000060000304_") = 0 Тогда
			ОбластьИмя = Область.Имя;
			ОбластьКод = ТабличныйДокумент.Области[СтрЗаменить(ОбластьИмя, "1_", "3_")];
