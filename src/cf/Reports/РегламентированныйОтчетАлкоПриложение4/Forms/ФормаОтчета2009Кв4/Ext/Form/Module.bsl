...
Функция СобратьДанныеТекущегоТаблПоля(Форма, ИмяТабличногоПоля)
	...
	Для Инд = 0 По ТабличноеПоле.Области.Количество() - 1 Цикл
		...
		Если Найти(ИмяПоказателя, "СуммаКолонка") > 0 Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли НЕ СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Титульный"
		...
		Если (Найти(Элемент.ТекущаяОбласть.Имя, "R") > 0) Или (Найти(Элемент.ТекущаяОбласть.Имя, "C") > 0) Тогда
			Возврат;
		КонецЕсли;

		РасчетНаКлиенте(СтруктураРеквизитовФормы.НаимТекущегоРаздела, Элемент.ТекущаяОбласть.Имя, Число(Сред(Элемент.ТекущаяОбласть.Имя, Найти(Элемент.ТекущаяОбласть.Имя, "_") + 1)));
		
	КонецЕсли;
	
	Если (СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Декларация") И (НЕ ((Найти(Элемент.ТекущаяОбласть.Имя, "П000000000002_") > 0) Или (Найти(Элемент.ТекущаяОбласть.Имя, "П000000000003_") > 0) Или (Найти(Элемент.ТекущаяОбласть.Имя, "П000000000004_") > 0))) Тогда	
		...
		Если (НЕ СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет) И (ФлажокИтог) Тогда
			...
			Если Найти(НомерКолонки, "0") = 1 Тогда
