...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.СхемаВыгрузкиXML   = "СхемаВыгрузкиXML2010Кв1";
	...
	НоваяФорма.СхемаВыгрузкиXML   = "СхемаВыгрузкиXML2013Кв1";
	
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2013Кв4";
	НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Росстата от 29.08.2012 № 470.";
	НоваяФорма.РедакцияФормы	  = "от 29.08.2012 № 470 (4 квартал).";
	НоваяФорма.ДатаНачалоДействия = '20131001';
	НоваяФорма.ДатаКонецДействия  = '20131231';
	НоваяФорма.СхемаВыгрузкиXML   = "СхемаВыгрузкиXML2013Кв4";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20100101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "610016", '20090728', "153",	"ФормаОтчета2010Кв1");
	Форма20130101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "610016", '20120829', "470",	"ФормаОтчета2013Кв1");
	Форма20131001 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "610016", '20120829', "470",	"ФормаОтчета2013Кв4");
	Форма20140101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "610016", '20130626', "232",	"ФормаОтчета2014Кв1");
	Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "610016", '20140904', "547",	"ФормаОтчета2015Кв1");
