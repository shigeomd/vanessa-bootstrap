...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПолеТабличногоДокументаФормаОтчета.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("ФормаОтчета2013Кв4_ФормаОтчета"));
...
Процедура СформироватьСпискиВыбора()
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Списки2013Кв4");
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрЧислоВхождений(Область.Имя, "УдалитьСтроку") > 0 Тогда
		УдалитьСтроку("");
	ИначеЕсли Найти(Область.Имя, "П000000300102_") = 1 Тогда
	...
	ИначеЕсли Не СтруктураРеквизитовФормы.мАвтоВыборКодов И Не Область.Защита И Найти(Область.Имя, "П0000003001") = 1 Тогда 
		...
		Если Найти(Область.Имя, "П000000300105_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000000300104_") = 1 Тогда
		...
		ИначеЕсли Найти(Область.Имя, "П000000300101_") = 1 Тогда 
			Если ЗначВСтолбцеБ = "50" Тогда
				ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "ОКП55");
			...
			ИначеЕсли ЗначВСтолбцеБ = "80" Тогда 
				...
				ВвестиПоказатель(Элемент, СмежнаяОбласть, КодПоказателя, Ложь, ПараметрВводаПоля.ТекстПриВыборе, ТЗВыбора, СтандартнаяОбработка, Область.Имя);
			КонецЕсли;
		ИначеЕсли Найти(Область.Имя, "П000000300103_") = 1 Или Найти(Область.Имя, "П000000300106_") = 1 Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ЗначениеЗаполнено(ОбластьНаименование) Тогда
		...
		Если Найти(ОбластьНаименование, "П000000300101_") = 1 Тогда 
	...
	Если Найти(Область.Имя, "П000000300102_") = 1 Тогда
		Показатель = Область.Значение;
		НомерСтроки = Сред(Область.Имя, 15);
		Если Показатель = "80" Тогда
