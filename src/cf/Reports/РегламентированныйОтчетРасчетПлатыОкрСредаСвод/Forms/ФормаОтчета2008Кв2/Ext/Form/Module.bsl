...
Процедура ВставитьДополнительнуюСтраницуВДругойРазделНаСервере(Форма, ИмяСтраницыПанели = Неопределено)
	...
	ТабличныйДокумент.Очистить();
	ТабличныйДокумент.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ИмяСтраницыПанели));
...
Функция ЭтотЛистЗаполнен(ТаблДок, ПодстрокаПоиска)
	...
	Для Каждого Обл Из ТаблДок.Области Цикл
		...
		Если Лев(Обл.Имя, 11) = ПодстрокаПоиска И Найти(Обл.Имя, "_") > 0 Тогда
...
Процедура ЗагрузитьПоказателиИзМакета(Знач РазделВМакете)	
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Списки2008Кв2");
...
Процедура УдалитьДополнительнуюСтраницуНаСервере(ИмяТекущейСтраницыПанели = Неопределено)
	...
	Если ИмяТекущейСтраницыПанели = "Раздел4" ИЛИ ИмяТекущейСтраницыПанели = "Раздел5" Тогда
		...
		ТабличныйДокумент.Очистить();
		ТабличныйДокумент.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ИмяДополнительнойСтраницыПанели));
	...
	Если Найти(РежимОчистки, "ОчиститьТекущийРаздел") > 0 Тогда
		...
		Если (Многостраничность) И (КолВоСтраницВРазделе > 1) Тогда
			...
			Для каждого ЭлИмяРаздела Из СтруктураИменРазделов Цикл
				...
				ТабличныйДокумент.Очистить();
				ТабличныйДокумент.Вывести(Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет(Сред(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_" + ЭлИмяРаздела.Ключ));
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	// Титульный
	Если Найти(Область.Имя,"ПредставляетсяВ") > 0 Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "РазмерОрганизации") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли Найти(Область.Имя,"КБК1") > 0 Тогда
		...
		КонецЕсли;
	// Раздел 1
	ИначеЕсли (Найти(Область.Имя, "П000010001002_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда // Колонка 2, наименование
	...
	ИначеЕсли (Найти(Область.Имя, "П000010001013_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000010001003") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000010001014") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000010001015") > 0) И (НЕ  СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000010001016") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	// Раздел 2
	ИначеЕсли (Найти(Область.Имя, "П000020001004") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000020001007") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000020001008") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000020001002") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
		...
		ОткрытьФорму("Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	ИначеЕсли (Найти(Область.Имя, "П000020001005_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
		...
		ОткрытьФорму("Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	ИначеЕсли (Найти(Область.Имя, "П000020001006_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000020001009_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
		...
		ОткрытьФорму("Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	ИначеЕсли (Найти(Область.Имя, "П000030001002") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда // Колонка 2
		...
		ОткрытьФорму("Обработка.ОбщиеОбъектыРегламентированнойОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	ИначеЕсли (Найти(Область.Имя, "П000030001012") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000030001013") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000030001015_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли ((Найти(Область.Имя, "П000040001002") > 0) Или     // Колонки 2 и 3
			   (Найти(Область.Имя, "П000040001003") > 0)) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
		
		СтандартнаяОбработка = Ложь;
		
		Если ДатаПодписи >= '2014-08-01' Тогда
			ПоисковаяТабл = мФКТОРаздел4_2014;
		Иначе
			ПоисковаяТабл = мФКТОРаздел4;
		КонецЕсли;
		
		Если Найти(Область.Имя, "П000040001002") = 1 Тогда
			Колонка = "Название";
			ПервоначальноеЗначение = Область.Значение;
		Иначе	
			Колонка = "Код";
	...
	ИначеЕсли (Найти(Область.Имя, "П000040001005") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000040001004") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	// Раздел 5
	ИначеЕсли (Найти(Область.Имя, "П000050001022") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000050001021_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000050001023_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
	...
	ИначеЕсли (Найти(Область.Имя, "П000050001024_") > 0) И (НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов) Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если Найти(Область.Имя, "ОКВЭД") > 0 Тогда
	...
	Если Найти(Область.Имя, "ОКАТО") > 0
	...
	Если ИмяРаздела <> "Титульный" Тогда 
		...
		Если ИмяРаздела = "Раздел4" Тогда
			Если (Найти(ИмяОбласти, "П000040001013") > 0) Или (Найти(ИмяОбласти, "П000040001014") > 0)
			 Или (Найти(ИмяОбласти, "П000040001006") > 0) Или (Найти(ИмяОбласти, "П000040001007") > 0)
			 Или (Найти(ИмяОбласти, "П000040001008") > 0) Или (Найти(ИмяОбласти, "П000040001009") > 0)
			 Или (Найти(ИмяОбласти, "П000040001010") > 0) Или (Найти(ИмяОбласти, "П000040001011") > 0)
			 Или (Найти(ИмяОбласти, "П000040001012") > 0) Тогда
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ПолнНаименованиеОрг) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задано полное наименование оганизации!", ИмяПоляТаблДокумента, "");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если НЕ РегламентированнаяОтчетность.ПроверитьРазделыНаНаличиеИнформации(ЭтаФорма, ДеревоВыгрузки, СтрПоляТаблДокумента) Тогда
		...
		// РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не заполнен расчет формы!", "", "");
...
Процедура ОтсечьНезаполненныеНеобязательныеУзлы(Узел)
	...
	Если ТипЗнч(Узел) <> Тип("ДеревоЗначений") Тогда
		...
		Если (Найти(Узел.Обязательность, "Н") <> 0 ИЛИ Найти(Узел.Обязательность, "H") <> 0) И РегламентированнаяОтчетность.УзелПуст(Узел) Тогда // учтем оба варианта: кириллицу и латиницу
			...
			Если Стр.Многостраничность Тогда
				...
				Если Не ПустаяСтрока(Стр.Раздел) И мДанныеОтчета.Свойство(Стр.Раздел, ЛистыМногостраничногоРаздела) Тогда
					Для Каждого Лист Из ЛистыМногостраничногоРаздела Цикл
						...
						ИначеЕсли Найти(Стр.Раздел, "Раздел2") > 0 Тогда
							Если ЗначениеЗаполнено(мДанныеОтчета.ОКАТОФильтр) И мДанныеОтчета.ОКАТОФильтр <> ДанныеЛиста.ОКАТО Тогда
								Продолжить;
							КонецЕсли;
							ДобавитьПоказателиВРаздел2(ДанныеЛиста, ИндексЛиста);
						ИначеЕсли Найти(Стр.Раздел, "Раздел3") > 0 Тогда
							Если ЗначениеЗаполнено(мДанныеОтчета.ОКАТОФильтр) И мДанныеОтчета.ОКАТОФильтр <> ДанныеЛиста.ОКАТО Тогда
								Продолжить;
							КонецЕсли;
							ДобавитьПоказателиВРаздел3(ДанныеЛиста, ИндексЛиста);
						ИначеЕсли Найти(Стр.Раздел, "Раздел4") > 0 Тогда
							Если ЗначениеЗаполнено(мДанныеОтчета.ОКАТОФильтр) И мДанныеОтчета.ОКАТОФильтр <> ДанныеЛиста.ОКАТО Тогда
								Продолжить;
							КонецЕсли;
	...
	Для каждого Показатель Из ДанныеЛиста Цикл
		Если Лев(Показатель.Ключ, 14) = "П000020001002_" Тогда
			...
			Для каждого СтрокаТаблицы Из мНормативыПлатыРаздел2 Цикл
				Если ЗначениеЗаполнено(Показатель.Значение) И Найти(СтрокаТаблицы.Название, СокрЛП(Показатель.Значение)) > 0 Тогда
...
Процедура ДобавитьПоказателиВРаздел4(ДанныеЛиста, ИндексЛиста)
	...
	Пока ДанныеЛиста.Свойство("П000040001003_" + Формат(НомСтр, "ЧГ=")) Цикл
		...
		КлассОпасности = 0;
		Если Найти(СтрКлассОпасности, "IV") > 0 Тогда
			КлассОпасности = 4;
		ИначеЕсли Найти(СтрКлассОпасности, "III") > 0 Тогда
			КлассОпасности = 3;
		ИначеЕсли Найти(СтрКлассОпасности,  "II") > 0 Тогда
			КлассОпасности = 2;
		ИначеЕсли Найти(СтрКлассОпасности,  "I") > 0 Тогда
			КлассОпасности = 1;
		ИначеЕсли Найти(СтрКлассОпасности,  "V") > 0 Тогда
			КлассОпасности = 5;
		КонецЕсли;
