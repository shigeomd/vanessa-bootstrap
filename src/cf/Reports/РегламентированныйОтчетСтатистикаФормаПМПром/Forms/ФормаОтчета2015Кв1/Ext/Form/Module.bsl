...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П002000100100",    , ,                          , КоллекцияСписковВыбора["СправочникПриложениеДляВводаОКПД"]);
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	ИначеЕсли (Найти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0) Тогда
		ИсходноеЗначение = ?(ТипЗнч(Область.Значение) = Тип("Строка"), СокрЛП(Область.Значение), Область.Значение);
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Найти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0 Тогда
...
Функция РазобратьСтрокуПравила(Знач СтрокаПравила)
	...
	ПозицияВыражения = Найти(СтрокаПравила, СимволБольшеРавно);
	
	Если ПозицияВыражения = 0 Тогда
		
		ПозицияВыражения = Найти(СтрокаПравила, СимволРавно);
	...
	Для Каждого Операнд Из МассивОперандовПравойЧасти Цикл
		...
		ПозицияМножителя = Найти(Операнд, "*");
...
Функция СформироватьТаблицуКонтрольныхСоотношений() 
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("КонтрольныеСоотношения2015Кв1");
