...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Схема				  = ОбъектОтчет.ПолучитьМакет(Параметры.ИмяМакета);
	...
	Отчет.КомпоновщикНастроек.ЗагрузитьНастройки(ПолучитьИзВременногоХранилища(Параметры.Настройка));
...
Функция ПолучитьСтруктуруОповещения()
	...
	Возврат Новый Структура("ИмяМакета, Настройка", Параметры.ИмяМакета, Отчет.КомпоновщикНастроек.ПолучитьНастройки());
...
Процедура СохранитьНастройку(Команда)
	...
	ОповеститьОВыборе(ПолучитьСтруктуруОповещения());
