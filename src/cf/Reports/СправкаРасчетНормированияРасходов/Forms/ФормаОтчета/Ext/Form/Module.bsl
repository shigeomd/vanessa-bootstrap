...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Отчет = Форма.Отчет;
	ЗаголовокОтчета = НСтр("ru = 'Справка-расчет нормирования расходов'");
	ЗаголовокОтчета = ЗаголовокОтчета + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
