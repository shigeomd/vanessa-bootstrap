...
Процедура ЗаполнитьСведенияОбОрганизации(ИзмененаДатаПодписи = Ложь)
	...
	Сведения = "КППЮЛ, НаимЮЛПол, КодНО, НаимНО, НаимИОПол, ТипНП, ТелОрганизации, ОКВЭД, ФИОРук, ФИО, ИННЮЛ";
	...
	ТабличныйДокумент.Области.ИноОргНазв.Значение = СведенияОбОрганизации.НаимИОПол;
	ТабличныйДокумент.Области.ОргНазв.Значение = НаименованиеОрганизации;
	ТабличныйДокумент.Области.ОргДиректор.Значение = СведенияОбОрганизации.ФИОРук;
	...
	Иначе
		...
		Для Каждого Строка Из ТаблицаВариантыЗаполнения Цикл
			...
			Если Форма.ТабличныйДокумент.Области.Найти(ИмяПоказателя) = Неопределено Тогда
				ИмяПоказателя = Лев(ИмяПоказателя, Найти(ИмяПоказателя, "_") - 1);
			КонецЕсли;
...
Процедура ОбработкаВыбораИФНСЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыбора <> Неопределено Тогда
		...
		ПроставитьСведенияОПредставителеОрганизацииНаКлиенте();
...
Процедура ПолеТабличногоДокументаРаздел2Выбор(Элемент, Область, СтандартнаяОбработка)
	...
	// Код водопользования
	Если Найти(ОбластьИмя, "П000210004000") > 0 Тогда
...
Процедура ПолеТабличногоДокументаРаздел22Выбор(Элемент, Область, СтандартнаяОбработка)
	...
	// Код водопользования
	Если Найти(ОбластьИмя, "П000220004000") > 0 Тогда
...
Процедура ПолеТабличногоДокументаРаздел23Выбор(Элемент, Область, СтандартнаяОбработка)
	...
	// Код водопользования
	Если Найти(ОбластьИмя, "П000230004000") > 0 Тогда
...
Процедура ПолеТабличногоДокументаРаздел24Выбор(Элемент, Область, СтандартнаяОбработка)
	...
	// Код водопользования
	Если Найти(ОбластьИмя, "П000240004000") > 0 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	// КБК
	Если Найти(ОбластьИмя, "П000010002000") > 0
		ИЛИ Найти(ОбластьИмя, "П000210001000") > 0
		Или Найти(ОбластьИмя, "П000220001000") > 0
		ИЛИ Найти(ОбластьИмя, "П000230001000") > 0
		ИЛИ Найти(ОбластьИмя, "П000240001000") > 0 Тогда
	...
	ИначеЕсли Найти(ОбластьИмя, "П000210003000") > 0
		ИЛИ Найти(ОбластьИмя, "П000220003000") > 0
		ИЛИ Найти(ОбластьИмя, "П000230003000") > 0
		ИЛИ Найти(ОбластьИмя, "П000240003000") > 0 Тогда
