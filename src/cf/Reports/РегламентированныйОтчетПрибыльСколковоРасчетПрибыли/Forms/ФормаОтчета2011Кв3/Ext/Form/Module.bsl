...
// Процедура устанавливает цвет фона и защиту ячейки в зависимости от варианта заполнения
//
...
// Процедура предназначена для заполнения значения показателя суммой показателей по списку в заданном поле табличного документа
