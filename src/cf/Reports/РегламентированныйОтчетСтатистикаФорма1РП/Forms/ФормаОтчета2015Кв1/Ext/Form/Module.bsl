...
Функция СформироватьСтруктуруПараметров()
	...
	ОтчПериод = ?(Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) = 12, 12, Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) / 3);
...
Функция СформироватьСтруктуруДопАтрибутов()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, Найти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("АтрибВыгрузкиXML2015Кв1");
	ИмяОбласти = ?(Месяц(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) = 12, "АтрПериодГод", "АтрПериодКвартал");
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	// 3.
	// Cтрока 01 >= стр. 02 по всем графам.
