...
Процедура УдалитьВсеСтраницы(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("УдалитьВсеСтраницыЗавершение", ЭтотОбъект, ДополнительныеПараметры);
...
Процедура УдалитьВсеСтраницыЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Декларация" Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если (СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Декларация") И (НЕ ((Найти(Элемент.ТекущаяОбласть.Имя, "П000000000002_") > 0) Или (Найти(Элемент.ТекущаяОбласть.Имя, "П000000000003_") > 0))) Тогда
