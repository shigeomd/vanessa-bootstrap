...
Процедура ВыгрузитьОтчет(Команда)
	...
	Если НЕ ЗначениеЗаполнено(АдресХранилищаФайлаВыгрузки) 
		ИЛИ Элементы.Результат.ОтображениеСостояния.ДополнительныйРежимОтображения = ДополнительныйРежимОтображения.Неактуальность Тогда
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	Элементы.Результат.ИспользуемоеИмяФайла = ИмяФайла;
